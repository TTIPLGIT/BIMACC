  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="rate_of_interest" class="form-control check-size" style="width:7%" name="rate_of_interest"  value="yes "{{ $details->rate_of_interest == 'yes' ? 'checked' : ''}}  >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="amount_of_debt" class="form-control check-size" style="width:7%" name="amount_of_debt"  value="yes"{{ $details->amount_of_debt == 'yes' ? 'checked' : ''}}  >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="damages_rs" class="form-control check-size" style="width:7%" name="damages_rs"  value="yes"{{ $details->damages_rs == 'yes' ? 'checked' : ''}}  >
...
<div class="col-md-6"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="rate_of_penal_interest" class="form-control check-size" style="width:7%" name="rate_of_penal_interest"  value="yes"{{ $details->rate_of_penal_interest == 'yes' ? 'checked' : ''}} >

      ...
      <div class="col-md-4">  
        <div class="form-group">
          <input type="date"   name="sdate_of_contract"  class="datechk form-control{{ $errors->has('date_of_contract') ? ' is-invalid' : '' }}"  value="{{$details->date_of_contract}}">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <input type="date"  id="sdate_of_notification" class="datechk form-control{{ $errors->has('date_of_notification') ? ' is-invalid' : '' }}" name="date_of_notification"  value="{{$details->date_of_notification}}">
  ...
  <div class="row">
    <div class="col-md-6"> 
      <div class="form-group">
       <input type="date"  id="sdate_of_tender" class="datechk form-control{{ $errors->has('date_of_tender') ? ' is-invalid' : '' }}" name="date_of_tender"  value="{{$details->date_of_tender}}" >

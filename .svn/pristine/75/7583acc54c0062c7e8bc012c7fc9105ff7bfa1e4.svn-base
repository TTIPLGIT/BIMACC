...
<div class="row">
  <div class="col-md-1"><input class="form-control" value="{{$count_in}}"  type="text" disabled ><label class="form-control-placeholder">Sl. No.</label></div>
        ...
        <div class="col-md-3"> 
          <div class="form-group">
           <input type="date" id="sdate_of_cintract_real" class="datechk form-control{{ $errors->has('date_of_cintract_real') ? ' is-invalid' : '' }}"   value="{{$realestate_claims->date_of_cintract_real}}" readonly>
...
<div class="row">
  <div class="col-md-6"> 
    <div class="form-group">
     <input type="date" id="sdate_of_breach_real" class="datechk form-control{{ $errors->has('date_of_breach_real') ? ' is-invalid' : '' }}"  value="{{$realestate_claims->date_of_breach_real}}" readonly>
...
<div class="col-md-5"> 
  <div class="form-group">
   <input type="date" id="sdate_of_notice_real" class="datechk form-control{{ $errors->has('date_of_notice_real') ? ' is-invalid' : '' }}"  value="{{$realestate_claims->date_of_notice_real}}" readonly>

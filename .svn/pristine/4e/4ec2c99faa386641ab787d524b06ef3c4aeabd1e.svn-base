    ...
    <div class="col-md-12">
       ...
       <div class="row">
        <div class="col-md-3"> 
          <div class="form-group">
           ...
           <input type="checkbox" class="form-control check-size" id="demand_to_stop_infringement_select"  name="demand_to_stop_infringement_select" style="width:9%"  value="yes" {{ $details->demand_to_stop_infringement_select == 'yes' ? 'checked' : ''}}
           >
         </div>
       </div>
       <div class="col-md-3"> 
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="nature_of_property"  name="nature_of_property" style="width:9%"  value="yes" {{ $details->nature_of_property == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
   ...
   <div class="row">
     <div class="col-md-3"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="demand_for_licence_fee"  name="demand_for_licence_fee" style="width:9%"  value="yes"  {{ $details->demand_for_licence_fee == 'yes' ? 'checked' : ''}}
       >
     </div>
   </div>
   <div class="col-md-3"> 
...
<div class="row">
  <div class="col-md-3"> 
    <div class="form-group">
     ...
     <input type="checkbox" class="form-control check-size" id="cancellation_license"  name="cancellation_license" style="width:9%"  value="yes" {{ $details->cancellation_license == 'yes' ? 'checked' : ''}}
     >
   </div>
 </div>
 <div class="col-md-4"> 
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="value_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:9%" value="yes" {{ $details->value_claims_withoutinterest == 'yes' ? 'checked' : ''}}
   >
 </div>
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="damages_for_breach_of_contract_withoutinterest"  name="damages_for_breach_of_contract_withoutinterest" style="width:9%"  value="yes" {{ $details->damages_for_breach_of_contract_withoutinterest == 'yes' ? 'checked' : ''}}
   >
 </div>
</div>
</div>
<div class="row">
 <div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="demand_to_surrender_infringed_materials"  name="demand_to_surrender_infringed_materials" style="width:9%"  value="yes" {{ $details->demand_to_surrender_infringed_materials == 'yes' ? 'checked' : ''}}
   >
 </div>
</div>
<div class="col-md-3"> 
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="value_infringing_withoutinterest"  name="value_infringing_withoutinterest" style="width:9%"  value="yes" {{ $details->value_infringing_withoutinterest == 'yes' ? 'checked' : ''}}
   >
 </div>
</div>

  ...
  <div class="row register-form">
    <div class="col-md-12">
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="claimforcontractpriceinerestwithoutinterest"  name="claimforcontractpriceinerestwithoutinterest" style="width:7%" value="yes">
    ...
    <div class="col-md-4"> 
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="refund_withoutinterest"  name="refund_withoutinterest" style="width:7%"  value="yes">
       </div>
     </div>
     ...
     <div class="row">
      <div class="col-md-3"> 
          <div class="form-group">
           ...
           <input type="checkbox" class="form-control check-size" id="demand_to_stop_infringement_select"  name="demand_to_stop_infringement_select" style="width:7%"  value="yes">
         </div>
       </div>
       <div class="col-md-3"> 
      <div class="form-group">
      ...
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="demand_for_licence_fee"  name="demand_for_licence_fee" style="width:7%"  value="yes"  >
     </div>
   </div>
   ...
   <div class="row">
    ...
    <div class="form-group">
     ...
     <input type="checkbox" class="form-control check-size" id="demand_for_licence_fee_withoutinterest"  name="demand_for_licence_fee_withoutinterest" style="width:7%"  value="yes"  >
   </div>
 </div>
     <div class="col-md-3"> 
      <div class="form-group">
    ...
    <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="to_return_materials"  name="to_return_materials" style="width:7%" value="yes">
       </div>
     </div>
     <div class="col-md-3"> 
  <div class="form-group">
   ...
   <div class="row">
     <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="to_cancel_performance_guarantees"  name="to_cancel_performance_guarantees" style="width:7%" value="yes">
       </div>
     </div>
     <div class="col-md-3"> 
  <div class="form-group">
...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
  @csrf  
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="claimforcontractpriceinerestwithoutinterest"  name="claimforcontractpriceinerestwithoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->claimforcontractpriceinerestwithoutinterest == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
   ...
   <div class="row">
    ...
    <div class="col-md-4"> 
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="refund_withoutinterest" style="margin-left: 18px;">Without Interest</label>
         <input type="checkbox" class="form-control check-size" id="refund_withoutinterest" value="yes" name="refund_withoutinterest" style="width:7%"  {{ $ReliefRequest->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   ...
   <div class="row">
    ...
    <div class="col-md-4"> 
      ...
      <div class="col-md-3"> 
          <div class="form-group">
           <label class="form-control-placeholder"  for="demand_to_stop_infringement_select" style="margin-left: 18px;">To Terminate Contract:</label>
           <input type="checkbox" class="form-control check-size" id="demand_to_stop_infringement_select"  name="demand_to_stop_infringement_select" style="width:7%"  value="yes" {{ $ReliefRequest->demand_to_stop_infringement_select == 'yes' ? 'checked' : ''}}>
         </div>
       </div>
       <div class="col-md-3"> 
      <div class="form-group">
      ...
      <div class="form-group">
       <label class="form-control-placeholder" for="demand_for_licence_fee" style="margin-left: 18px;">To Vacate Contractual Site:</label>
       <input type="checkbox" class="form-control check-size" id="demand_for_licence_fee"  name="demand_for_licence_fee" style="width:7%"  value="yes" {{ $ReliefRequest->demand_for_licence_fee == 'yes' ? 'checked' : ''}}  >
     </div>
   </div>
   ...
   <div class="row">
    ...
    <div class="form-group">
     <label class="form-control-placeholder" for="demand_for_licence_fee_withoutinterest" style="margin-left: 18px;">Specific Performance of Contract:</label>
     <input type="checkbox" class="form-control check-size" id="demand_for_licence_fee_withoutinterest"  name="demand_for_licence_fee_withoutinterest" style="width:7%"  value="yes" {{ $ReliefRequest->demand_for_licence_fee_withoutinterest == 'yes' ? 'checked' : ''}}  >
   </div>
 </div>
     <div class="col-md-3"> 
      <div class="form-group">
    ...
    <div class="col-md-3"> 
        <div class="form-group">
         <label class="form-control-placeholder" id="to_return_materials" for="to_return_materials" style="margin-left: 18px;">To Return Materials</label>
         <input type="checkbox" class="form-control check-size" id="to_return_materials"  name="to_return_materials" style="width:7%"   value="yes" {{ $ReliefRequest->to_return_materials == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
        <div class="col-md-3"> 
      ...
      <div class="row">
        ...
        <div class="form-group">
         <label class="form-control-placeholder" id="to_cancel_performance_guarantees" for="to_cancel_performance_guarantees" style="margin-left: 18px;">To Cancel Performance Guarantees</label>
         <input type="checkbox" class="form-control check-size" id="to_cancel_performance_guarantees"  name="to_cancel_performance_guarantees" style="width:7%" value="yes" {{ $ReliefRequest->to_cancel_performance_guarantees == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
    <div class="col-md-3"> 

...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="claimamountwithinterest"  name="claimamountwithinterest" style="width:7%" value="yes" >
  </div>
</div>
</div>
...
<div class="col-md-4"> 
  <div class="form-group">
     <label class="form-control-placeholder" for="claimamountwithinterest" style="margin-left: 18px;">Without Interest: </label>
    <input type="checkbox" class="form-control check-size" id="claimamountwithinterest"  name="claimamountwithinterest" style="width:7%" value="yes"  {{ $claimDetail->claimamountwithinterest == 'yes' ? 'checked' : ''}}>
  </div>
</div>
</div>

...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="eid_claim_for_contract_price_withoutinterest" class="form-control check-size" style="width:7%" name="eid_claim_for_contract_price_withoutinterest" value="yes" {{ $details->eid_claim_for_contract_price_withoutinterest == 'yes' ? 'checked' : ''}} >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="eid_claim_for_refund_withoutinterest" class="form-control check-size" style="width:7%" name="eid_claim_for_refund_withoutinterest" value="yes" {{ $details->eid_claim_for_refund_withoutinterest == 'yes' ? 'checked' : ''}}>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="claim_for_escalation_of_costs_withoutinterest"  name="claim_for_escalation_of_costs_withoutinterest" style="width:7%" value="yes" {{ $details->claim_for_escalation_of_costs_withoutinterest == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="claim_for_damages_withoutinterest"  name="claim_for_damages_withoutinterest" style="width:7%" value="yes" {{ $details->claim_for_damages_withoutinterest == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="to_terminate_contract"  name="to_terminate_contract" style="width:9%" value="yes" {{ $details->to_terminate_contract == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="col-md-3"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="to_vacate_contractual_site"  name="to_vacate_contractual_site" style="width:9%" value="yes" {{ $details->to_vacate_contractual_site == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="return_material_value"  name="return_material_value" style="width:9%" value="yes" {{ $details->return_material_value == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="substitute_contractor"  name="substitute_contractor" style="width:7%" value="yes" {{ $details->substitute_contractor == 'yes' ? 'checked' : ''}}>
  </div>

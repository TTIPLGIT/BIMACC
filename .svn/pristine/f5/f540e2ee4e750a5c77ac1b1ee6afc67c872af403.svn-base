...
<div class="row">
  ...
  <button type="submit" class="btn btn-success btn-space but_margin" id="add_newaccount1" style=" margin-left: 449px;">Save & Add Account</button>
</form>
</div>
...
<div class="row">
  <input class="form-control" value="{{$bank_accounts->bank_id}}" name="loan_id_forupdate" style="display: none;"type="text"  >
   <div class="col-md-2"><input class="form-control loan-num" placeholder='Loan{{ $loop->iteration}}'  type="text" disabled ></div>
          <div class="col-md-2"> 
            <div class="form-group">
...
<div class="row">
  ...
  <button type="submit" class="btn btn-success btn-space but_margin" id="add_newaccount_update1" style=" margin-left: 449px;">Save & Add Account</button>
</div>

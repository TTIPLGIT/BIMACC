...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="rclaim_subs_contrib_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_subs_contrib_amount_withoutinterest" value="yes" >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="rclaim_refund_deposit_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_refund_deposit_amount_withoutinterest" value="yes" >

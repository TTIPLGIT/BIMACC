...
<div class="col-md-4"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_subs_contrib_amount_withoutinterest" style="margin-left: 35px;">Without Interest</label>
    <input type="checkbox" id="claim_subs_contrib_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_subs_contrib_amount_withoutinterest" value="yes" >
...
<div class="col-md-4"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_refund_deposit_amount_withoutinterest" style="margin-left: 35px;">Without Interest</label>
    <input type="checkbox" id="claim_refund_deposit_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_refund_deposit_amount_withoutinterest" value="yes" >
...
<div class="row">
  <div class="col-md-3"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_for_admission_and_removal_of_members_check" style="margin-left: 35px;margin-top: -8px;">Claim for Admission and Removal of Members</label>
    <input type="checkbox" id="claim_for_admission_and_removal_of_members_check" class="form-control check-size" style="width:9%" name="claim_for_admission_and_removal_of_members_check" value="yes" >
  ...
  <div class="col-md-3"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_remove_or_reinstate_office_bearers_check" style="margin-left: 35px;margin-top: -8px;">Claim to Remove or Reinstate Office Bearers</label>
    <input type="checkbox" id="claim_to_remove_or_reinstate_office_bearers_check" class="form-control check-size" style="width:9%" name="claim_to_remove_or_reinstate_office_bearers_check" value="yes" >
...
<div class="row">
  <div class="col-md-3"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_for_holding_or_postponement_of_elections_check" style="margin-left: 35px;margin-top: -8px;">Claim for Holding or Postponement of Elections</label>
    <input type="checkbox" id="claim_for_holding_or_postponement_of_elections_check" class="form-control check-size" style="width:9%" name="claim_for_holding_or_postponement_of_elections_check" value="yes" >
  ...
  <div class="col-md-3"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_appoint_auditors_or_investigators_check" style="margin-left: 35px;margin-top: -8px;">Claim to Appoint Auditors or Investigators</label>
    <input type="checkbox" id="claim_to_appoint_auditors_or_investigators_check" class="form-control check-size" style="width:9%" name="claim_to_appoint_auditors_or_investigators_check" value="yes" >
  ...
  <div class="row">
     <div class="col-md-3"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_appoint_auditors_check" style="margin-left: 35px;">Claim to Appoint Auditors</label>
    <input type="checkbox" id="claim_to_appoint_auditors_check" class="form-control check-size" style="width:9%" name="claim_to_appoint_auditors_check" value="yes" >
   ...
   <div class="col-md-3"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_render_accounts_check" style="margin-left: 35px;">Claim to Render Accounts</label>
    <input type="checkbox" id="claim_to_render_accounts_check" class="form-control check-size" style="width:9%" name="claim_to_render_accounts_check" value="yes" >
  ...
  <div class="row">
    <div class="col-md-3"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_against_members_for_damages_and_nuisance_check" style="margin-left: 35px;margin-top: -8px;">Claim Against Members for Damages and Nuisance</label>
    <input type="checkbox" id="claim_against_members_for_damages_and_nuisance_check" class="form-control check-size" style="width:9%" name="claim_against_members_for_damages_and_nuisance_check" value="yes" >
  ...
  <div class="col-md-3"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_carryout_repairs_or_renovation_check" style="margin-left: 35px;">Claim to Carryout Repairs or Renovation</label>
    <input type="checkbox" id="claim_to_carryout_repairs_or_renovation_check" class="form-control check-size" style="width:9%" name="claim_to_carryout_repairs_or_renovation_check" value="yes" >
...
<div class="col-md-4"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_subs_contrib_amount_withoutinterest" style="margin-left: 35px;">Without Interest</label>
    <input type="checkbox" id="claim_subs_contrib_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_subs_contrib_amount_withoutinterest" value="yes" {{ $ReliefRequest->claim_subs_contrib_amount_withoutinterest == 'yes' ? 'checked' : ''}} >
...
<div class="col-md-4"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_refund_deposit_amount_withoutinterest" style="margin-left: 35px;">Without Interest</label>
    <input type="checkbox" id="claim_refund_deposit_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_refund_deposit_amount_withoutinterest" value="yes" {{ $ReliefRequest->claim_refund_deposit_amount_withoutinterest == 'yes' ? 'checked' : ''}} >
...
<div class="row">
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_for_admission_and_removal_of_members_check" style="margin-left: 35px;margin-top: -8px;">Claim for Admission and Removal of Members</label>
    <input type="checkbox" id="claim_for_admission_and_removal_of_members_check" class="form-control check-size" style="width:9%" name="claim_for_admission_and_removal_of_members_check" value="yes" {{ $ReliefRequest->claim_for_admission_and_removal_of_members_check == 'yes' ? 'checked' : ''}} >
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_remove_or_reinstate_office_bearers_check" style="margin-left: 35px;margin-top: -8px;">Claim to Remove or Reinstate Office Bearers</label>
    <input type="checkbox" id="claim_to_remove_or_reinstate_office_bearers_check" class="form-control check-size" style="width:9%" name="claim_to_remove_or_reinstate_office_bearers_check" value="yes" {{ $ReliefRequest->claim_to_remove_or_reinstate_office_bearers_check == 'yes' ? 'checked' : ''}} >
...
<div class="row">
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_for_holding_or_postponement_of_elections_check" style="margin-left: 35px;margin-top: -8px;">Claim for Holding or Postponement of Elections</label>
    <input type="checkbox" id="claim_for_holding_or_postponement_of_elections_check" class="form-control check-size" style="width:9%" name="claim_for_holding_or_postponement_of_elections_check" value="yes" {{ $ReliefRequest->claim_for_holding_or_postponement_of_elections_check == 'yes' ? 'checked' : ''}} >
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_appoint_auditors_or_investigators_check" style="margin-left: 35px;margin-top: -8px;">Claim to Appoint Auditors or Investigators</label>
    <input type="checkbox" id="claim_to_appoint_auditors_or_investigators_check" class="form-control check-size" style="width:9%" name="claim_to_appoint_auditors_or_investigators_check" value="yes" {{ $ReliefRequest->claim_to_appoint_auditors_or_investigators_check == 'yes' ? 'checked' : ''}} >
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_appoint_auditors_check" style="margin-left: 35px;">Claim to Appoint Auditors</label>
    <input type="checkbox" id="claim_to_appoint_auditors_check" class="form-control check-size" style="width:9%" name="claim_to_appoint_auditors_check" value="yes" {{ $ReliefRequest->claim_to_appoint_auditors_check == 'yes' ? 'checked' : ''}} >
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_render_accounts_check" style="margin-left: 35px;">Claim to Render Accounts</label>
    <input type="checkbox" id="claim_to_render_accounts_check" class="form-control check-size" style="width:9%" name="claim_to_render_accounts_check" value="yes" {{ $ReliefRequest->claim_to_render_accounts_check == 'yes' ? 'checked' : ''}} >
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_against_members_for_damages_and_nuisance_check" style="margin-left: 35px;margin-top: -8px;">Claim Against Members for Damages and Nuisance</label>
    <input type="checkbox" id="claim_against_members_for_damages_and_nuisance_check" class="form-control check-size" style="width:9%" name="claim_against_members_for_damages_and_nuisance_check" value="yes" {{ $ReliefRequest->claim_against_members_for_damages_and_nuisance_check == 'yes' ? 'checked' : ''}} >
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_to_carryout_repairs_or_renovation_check" style="margin-left: 35px;">Claim to Carryout Repairs or Renovation</label>
    <input type="checkbox" id="claim_to_carryout_repairs_or_renovation_check" class="form-control check-size" style="width:9%" name="claim_to_carryout_repairs_or_renovation_check" value="yes" {{ $ReliefRequest->claim_to_carryout_repairs_or_renovation_check == 'yes' ? 'checked' : ''}} >

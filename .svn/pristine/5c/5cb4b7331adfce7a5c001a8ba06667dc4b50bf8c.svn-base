...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="rdamageamountinterestwithinterest"  name="damageamountinterestwithinterest" style="width:7%" value="yes" onclick="document.getElementById('damage_amount_interest').disabled=this.checked;" >
  </div>
</div>

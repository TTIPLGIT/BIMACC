...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="reid_claim_for_contract_price_withoutinterest" class="form-control check-size" style="width:7%" name="eid_claim_for_contract_price_withoutinterest"  value="yes" onclick="document.getElementById('eid_claim_for_contract_price_interest').disabled=this.checked;" >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="reid_claim_for_refund_withoutinterest" class="form-control check-size" style="width:7%" name="eid_claim_for_refund_withoutinterest" value="yes" onclick="document.getElementById('eid_claim_for_refund_interest').disabled=this.checked;" >
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="rclaim_for_escalation_of_costs_withoutinterest"  name="claim_for_escalation_of_costs_withoutinterest" style="width:7%" value="yes">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="rclaim_for_damages_withoutinterest"  name="claim_for_damages_withoutinterest" style="width:7%" value="yes">
  </div>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="rvalue_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:7%" value="yes">
  </div>

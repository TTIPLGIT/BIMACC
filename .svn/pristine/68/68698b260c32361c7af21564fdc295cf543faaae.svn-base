...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="claimamountwithinterest"  name="claimamountwithinterest" style="width:7%" value="yes"  {{ $details->claimamountwithinterest == 'yes' ? 'checked' : ''}}>
  </div>
</div>
</div>

  <div class="row register-form" style="pointer-events: none;">
    <div class="col-md-12">
      ...
      <div class="row">
       ...
       <div class="col-md-4"> 
        <div class="form-group">
          <input type="text" onkeypress="return isNumberKey(event)"   id="sextent"  class="form-control{{ $errors->has('extent') ? ' is-invalid' : '' }}" name="extent" value="{{ number_format((float)$details->extent, 2, '.', '') }}">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <input type="text" onkeypress="return isNumberKey(event)"   id="snature_of_property" class="form-control{{ $errors->has('nature_of_property') ? ' is-invalid' : '' }}" name="nature_of_property"  value="{{ number_format((float)$details->nature_of_property, 2, '.', '') }}">
    ...
    <div class="col-md-4"> 
          <div class="form-group">
           ...
           <input type="checkbox" class="form-control check-size" id="srendition_of_accounts"  name="rendition_of_accounts" style="width:7%" value="yes" {{ $details->rendition_of_accounts == 'yes' ? 'checked' : ''}}>
         </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="srendition_and_distribution_of_mense_profits_withoutint"  name="rendition_and_distribution_of_mense_profits_withoutint" style="width:7%" value="yes" {{ $details->rendition_and_distribution_of_mense_profits_withoutint == 'yes' ? 'checked' : ''}}>
     </div>
 ...
 <div class="row">
    ...
    <!-- <div class="col-md-4"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"   id="srendition_of_accounts"  class="form-control{{ $errors->has('rendition_of_accounts') ? ' is-invalid' : '' }}" name="rendition_of_accounts" >

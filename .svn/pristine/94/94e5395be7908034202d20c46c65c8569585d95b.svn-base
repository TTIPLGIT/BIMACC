     ...
     <div class="row">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="money_claim_amount_withoutinterest"  name="money_claim_amount_withoutinterest" style="width:7%" value="yes" {{ $details->money_claim_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   ...
   <div class="row">
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="claim_restrain"  name="claim_restrain" style="width:7%" value="yes" {{ $details->claim_restrain == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="claim_for_withoutinterest"  name="claim_for_withoutinterest" style="width:7%" value="yes" {{ $details->claim_for_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>  
     </div> 
      <div class="row">
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="claim_for_royalty_withoutinterest"  name="claim_for_royalty_withoutinterest" style="width:7%" value="yes" {{ $details->claim_for_royalty_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>  
     </div> 
     <div class="row">
      ...
      <div class="col-md-6"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="cancellation_of_agreement"  name="cancellation_of_agreement" style="width:5%" value="yes" {{ $details->cancellation_of_agreement == 'yes' ? 'checked' : ''}}>
       </div>
     </div> 
      <div class="col-md-6"> 
      <div class="form-group">

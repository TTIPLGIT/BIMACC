...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="rbenefit_withoutinterest"  name="benefit_withoutinterest" style="width:9%"  value="yes">
  </div>
</div>
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="raverage_value_withoutinterest"  name="average_value_withoutinterest" style="width:7%" value="yes">
  </div>

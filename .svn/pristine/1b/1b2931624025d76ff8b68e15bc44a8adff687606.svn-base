...
<div class="col-md-4"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="refund_withoutinterest" style="margin-left: 18px;">Without Interest</label>
   <input type="checkbox" class="form-control check-size" id="refund_withoutinterest"  name="refund_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
 </div>
</div>

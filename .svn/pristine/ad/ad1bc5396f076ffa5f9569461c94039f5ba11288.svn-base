    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="claimforcontractpriceinerestwithoutinterest"  name="claimforcontractpriceinerestwithoutinterest" style="width:7%" value="yes" {{ $details->claimforcontractpriceinerestwithoutinterest == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
    ...
    <div class="col-md-4"> 
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="refund_withoutinterest" value="yes" name="refund_withoutinterest" style="width:7%"  {{ $details->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   ...
   <div class="row">
    ...
    <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="to_return_materials"  name="to_return_materials" style="width:9%"   value="yes" {{ $details->to_return_materials == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
        <div class="col-md-3"> 
      ...
      <div class="row">
        ...
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="to_cancel_performance_guarantees"  name="to_cancel_performance_guarantees" style="width:9%" value="yes" {{ $details->to_cancel_performance_guarantees == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
    <div class="col-md-3"> 

 ...
 -->          <div class="form-group text-center" style="margin-bottom: 1.4em !important;">
     ...
     <div class="row">
        <div class="col-md-4"> 
          <div class="form-group">
           ...
           <input type="text" onkeypress="return isNumberKey(event)"  id="smoney_claim_amount"   class="form-control{{ $errors->has('money_claim_amount') ? ' is-invalid' : '' }}" name="money_claim_amount" value="{{ number_format((float)$details->money_claim_amount, 2, '.', '') }}">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
          <input type="text" onkeypress="return isNumberKey(event)"  id="smoney_claim_amount_interest" class="form-control{{ $errors->has('money_claim_amount_interest') ? ' is-invalid' : '' }}" name="money_claim_amount_interest"  value="{{ $details->money_claim_amount_interest }}">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="smoney_claim_amount_withoutinterest"  name="money_claim_amount_withoutinterest" style="width:7%" value="yes" {{ $details->money_claim_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
   ...
   <div class="row">
       <div class="col-md-4"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"  id="srendition_of_accounts_contract_value"  class="form-control{{ $errors->has('rendition_of_accounts_contract_value') ? ' is-invalid' : '' }}" name="rendition_of_accounts_contract_value" value="{{ number_format((float)$details->rendition_of_accounts_contract_value, 2, '.', '') }}">
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="sclaim_restrain"  name="claim_restrain" style="width:7%" value="yes" {{ $details->claim_restrain == 'yes' ? 'checked' : ''}}>
       </div>
     </div>

    <div class="col-md-4"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"  id="scontract_value"  class="form-control{{ $errors->has('contract_value') ? ' is-invalid' : '' }}" name="contract_value" value="{{ number_format((float)$details->contract_value, 2, '.', '') }}">
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="sclaim_for_withoutinterest"  name="claim_for_withoutinterest" style="width:7%" value="yes" {{ $details->claim_for_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>  
     </div> 
      <div class="row">
    <div class="col-md-4"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_for_royalty"  class="form-control{{ $errors->has('claim_for_royalty') ? ' is-invalid' : '' }}" name="claim_for_royalty" value="{{ number_format((float)$details->claim_for_royalty, 2, '.', '') }}">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_for_royalty_interest"  class="form-control{{ $errors->has('claim_for_royalty_interest') ? ' is-invalid' : '' }}" name="claim_for_royalty_interest" value="{{ $details->claim_for_royalty_interest }}">
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="sclaim_for_royalty_withoutinterest"  name="claim_for_royalty_withoutinterest" style="width:7%" value="yes" {{ $details->claim_for_royalty_withoutinterest == 'yes' ? 'checked' : ''}}>
       </div>
     </div>  
     </div> 
     <div class="row">
      ...
      <div class="col-md-6"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="scancellation_of_agreement"  name="cancellation_of_agreement" style="width:5%" value="yes" {{ $details->cancellation_of_agreement == 'yes' ? 'checked' : ''}}>
       </div>
     </div> 
      <div class="col-md-6"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"  id="scancellation_of_agreement_value"  class="form-control{{ $errors->has('cancellation_of_agreement_value') ? ' is-invalid' : '' }}" name="cancellation_of_agreement_value" value="{{ number_format((float)$details->cancellation_of_agreement_value, 2, '.', '') }}">
   ...
   <div class="row">
        <div class="col-md-6"> 
      <div class="form-group">
        <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_for_specific_performance"  class="form-control{{ $errors->has('claim_for_specific_performance') ? ' is-invalid' : '' }}" name="claim_for_specific_performance"  value="{{ number_format((float)$details->claim_for_specific_performance, 2, '.', '') }}">

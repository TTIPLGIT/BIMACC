      ...
      <div class="col-md-6">  
        <div class="form-group">
          <input type="date"   name="date_of_contract"  class="datechk form-control{{ $errors->has('date_of_contract') ? ' is-invalid' : '' }}"  value="{{$details->date_of_contract}}"> 
    ...
    <div class="row">
     ...
     <div class="col-md-6"> 
      <div class="form-group">
       <input type="date"   class="datechk form-control{{ $errors->has('date_of_breach') ? ' is-invalid' : '' }}" name="date_of_breach"  value="{{$details->date_of_breach}}">
  ...
  <div class="col-md-6"> 
    <div class="form-group">
     <input type="date"   class="datechk form-control{{ $errors->has('date_of_notice') ? ' is-invalid' : '' }}" name="date_of_notice"  value="{{$details->date_of_notice}}">

   ...
   <div class="col-md-1"><input class="form-control" placeholder='Loan{{ $loop->iteration}}'  type="text" disabled ></div>
          <div class="col-md-2"> 
            <div class="form-group">
             <input type='number' step='0.01' id="sloan_acc" class="form-control{{ $errors->has('loan_acc') ? ' is-invalid' : '' }}" name="loan_acc_bank[]"  value="{{$bank_accounts->loan_acc_bank}}" readonly>
        ...
        <div class="col-md-3">  
        <div class="form-group">
          <input type="text" id="ssanction_ammount" name="sanction_ammount[]"  class="form-control{{ $errors->has('sanction_ammount') ? ' is-invalid' : '' }}" value="{{$bank_accounts->sanction_ammount}}" readonly>
        ...
        <div class="col-md-3"> 
          <div class="form-group">
            <input type="text" id="sdate_of_application_bank" class="form-control{{ $errors->has('date_of_application_bank') ? ' is-invalid' : '' }}" name="date_of_application_bank[]" value="{{$bank_accounts->date_of_application_bank}}" readonly>
        ...
        <div class="col-md-3"> 
         <div class="form-group">
           <input type="text" id="sdate_of_sanction" class="form-control{{ $errors->has('date_of_sanction') ? ' is-invalid' : '' }}"  value="{{$bank_accounts->date_of_sanction_bank}}" readonly>
...
<!-- <div class="col-md-1"><input class="form-control" placeholder='{{ $loop->iteration}}'  type="text" disabled ></div> -->
     <div class="col-md-3"> 
      <div class="form-group">
       <input type="text" id="ssecurity_type" class="form-control{{ $errors->has('security_type') ? ' is-invalid' : '' }}" name="security_type[]"  value="{{$security->security_type}}" readonly>
...
@if ($security->security_type =='mortgage')
    ...
    <div class="col-md-3"> 
      <div class="form-group">
       <input type="text" id="smortgage_property" class="form-control{{ $errors->has('mortgage_property') ? ' is-invalid' : '' }}" name="mortgage_property[]"  value="{{$security->mortgage_property}}" readonly>
  ...
  <div class="col-md-3"> 
    <div class="form-group">
      <input type="text" id="smortgage_value_bank" class="form-control{{ $errors->has('mortgage_value_bank') ? ' is-invalid' : '' }}" name="mortgage_value_bank[]"  value="{{$security->mortgage_value_bank}}" readonly>
  ...
  <div class="col-md-3"> 
   <div class="form-group">
     <input type="text" id="smortgage_schedule" class="form-control{{ $errors->has('mortgage_schedule') ? ' is-invalid' : '' }}" name="mortgage_schedule[]" value="{{$security->mortgage_schedule}}" readonly>
  ...
  <div class="col-md-3"> 
    <div class="form-group">
     <input type="text" id="smortgage_name" class="form-control{{ $errors->has('mortgage_name') ? ' is-invalid' : '' }}" name="mortgage_name[]"  value="{{$security->mortgage_name}}" readonly>
...
<div class="col-md-3">  
  <div class="form-group">
    <input type="text" id="smortgage_date" name="mortgage_date[]"  class="form-control{{ $errors->has('mortgage_date') ? ' is-invalid' : '' }}"  value="{{$security->mortgage_date}}" readonly>
...
@if ($security->security_type =='hypothecation')
  ...
  <div class="col-md-3"> 
    <div class="form-group">
     <input type="text" id="shypo_property" class="form-control{{ $errors->has('hypo_property') ? ' is-invalid' : '' }}" name="hypo_property[]"  value="{{$security->hypo_property}}" readonly>
...
<div class="col-md-3"> 
  <div class="form-group">
    <input type="text" id="shypo_value" class="form-control{{ $errors->has('hypo_value') ? ' is-invalid' : '' }}" name="hypo_value[]"  value="{{$security->hypo_value}}" readonly>
...
<div class="col-md-3"> 
 <div class="form-group">
   <input type="text" id="shypo_schedule" class="form-control{{ $errors->has('hypo_schedule') ? ' is-invalid' : '' }}" name="hypo_schedule[]" value="{{$security->hypo_schedule}}" readonly>
...
<div class="col-md-3"> 
 <div class="form-group">
   <input type="text" id="shypo_name" class="form-control{{ $errors->has('hypo_name') ? ' is-invalid' : '' }}" name="hypo_name[]" value="{{$security->hypo_name}}" readonly>
  ...
  @endif
   ...
   <div class="col-md-3">  
    <div class="form-group">
      <input type="text" id="shypo_date" name="hypo_date[]"  class="form-control{{ $errors->has('hypo_date') ? ' is-invalid' : '' }}" value="{{$security->hypo_date}}" readonly>
  ...
  <div class="col-md-3">  
    <div class="form-group">
      <input type="text" id="shypo_engine" name="hypo_engine[]"  class="form-control{{ $errors->has('hypo_engine') ? ' is-invalid' : '' }}"  value="{{$security->hypo_engine}}" readonly>
  ...
  <div class="col-md-3">  
    <div class="form-group">
      <input type="text" id="shypo_chassis" name="hypo_chassis[]"  class="form-control{{ $errors->has('hypo_chassis') ? ' is-invalid' : '' }}" value="{{$security->hypo_chassis}}" readonly>
...
@if ($security->security_type =='guarntee')
  ...
  <div class="col-md-3"> 
    <div class="form-group">
     <input type="text" id="sguarntee_name" class="form-control{{ $errors->has('guarntee_name') ? ' is-invalid' : '' }}" name="guarntee_name[]"  value="{{$security->guarntee_name}}" readonly>
...
<div class="col-md-3"> 
  <div class="form-group">
    <input type="text" id="sguarntor_agreement" class="form-control{{ $errors->has('guarntor_agreement') ? ' is-invalid' : '' }}" name="guarntor_agreement[]" value="{{$security->guarntor_agreement}}" readonly>
...
@if ($security->security_type =='other')
  ...
  <div class="col-md-3"> 
 <div class="form-group">
   <input type="text" id="sothers_details" class="form-control{{ $errors->has('others_details') ? ' is-invalid' : '' }}" name="others_details[]" value="{{$security->others_details}}" readonly>
  ...
  <div class="col-md-3"> 
    <div class="form-group">
     <input type="text" id="sothers_date" class="form-control{{ $errors->has('others_date') ? ' is-invalid' : '' }}" name="others_date[]"  value="{{$security->others_date}}" readonly>
...
@foreach ($renewal_date  as $renewal )
 @if($renewal->claim_id == $bank_accounts->bank_id)
  ...
  <!-- <div class="col-md-1"><input class="form-control" placeholder='{{ $loop->iteration}}'  type="text" disabled ></div> -->
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="srenewal_date" class="form-control{{ $errors->has('renewal_date') ? ' is-invalid' : '' }}" name="renewal_date[]" value="{{$renewal->renewal_date}}" readonly>
...
@foreach ($revival_date  as $revival )
 ...
 <!-- <div class="col-md-1"><input class="form-control" placeholder='{{ $loop->iteration}}'  type="text" disabled ></div> -->
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="srevival_date" class="form-control{{ $errors->has('revival_date') ? ' is-invalid' : '' }}"  value="{{$revival->revival_date}}" readonly>
...
@endforeach
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="sdate_of_dafault" class="form-control{{ $errors->has('date_of_dafault') ? ' is-invalid' : '' }}" name="date_of_dafault[]" value="{{$bank_accounts->date_of_dafault}}" readonly>
...
<!--  <div class="col-md-1"><input class="form-control" placeholder='{{ $loop->iteration}}'  type="text" disabled ></div> -->
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="slegal_notice" class="form-control{{ $errors->has('legal_notice') ? ' is-invalid' : '' }}" name="legal_notice[]" value="{{$legal->legal_notice}}" readonly>
...
@endforeach
 ...
 <!-- <div class="col-md-1"><input class="form-control" placeholder='{{ $loop->iteration}}'  type="text" disabled ></div> -->
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="sother_document" class="form-control{{ $errors->has('other_document') ? ' is-invalid' : '' }}" name="other_document[]" value="{{$other->other_document}}" readonly>
...
@endforeach
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="snpa_date_bank" class="form-control{{ $errors->has('npa_date_bank') ? ' is-invalid' : '' }}" name="npa_date_bank[]" value="{{$bank_accounts->npa_date_bank}}" readonly>
    ...
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="samount_as_account" class="form-control{{ $errors->has('amount_as_account') ? ' is-invalid' : '' }}" name="amount_as_account[]" value="{{$bank_accounts->amount_as_account}}" readonly>
    ...
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="sinterest_bank" class="form-control{{ $errors->has('interest_bank') ? ' is-invalid' : '' }}" name="interest_bank[]" value="{{$bank_accounts->interest_bank}}" readonly>
    ...
    <div class="col-md-3">
      <div class="form-group">
        <input type="text" id="spenel_interest_bank" class="form-control{{ $errors->has('penel_interest_bank') ? ' is-invalid' : '' }}"  value="{{$bank_accounts->penel_interest_bank}}" readonly>
    ...
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="sother_charges" class="form-control{{ $errors->has('other_charges') ? ' is-invalid' : '' }}" name="other_charges_bank[]" value="{{$bank_accounts->other_charges_bank}}" readonly>
    ...
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="number" id="soutstanding_amount" class="form-control{{ $errors->has('outstanding_amount') ? ' is-invalid' : '' }}" name="outstanding_amount" value="{{$bank_accounts->outstanding_amount}}" readonly>
    ...
    <div class="col-md-3"> 
      <div class="form-group">
        <input type="text" id="samount_as_date" class="form-control{{ $errors->has('amount_as_date') ? ' is-invalid' : '' }}" name="amount_as_date" value="{{$bank_accounts->amount_as_date}}" readonly>

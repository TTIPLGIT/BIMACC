   ...
   <div class="col-md-12" style="pointer-events: none;">
      ...
      <div class="row">
        ...
        <div class="col-md-4">  
          <div class="form-group">
           <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_for_consideration_amount" class="form-control{{ $errors->has('claim_for_consideration_amount') ? ' is-invalid' : '' }}" name="claim_for_consideration_amount"  value="{{ number_format((float)$details->claim_for_consideration_amount, 2, '.', '') }}" >
      ...
      <div class="col-md-4">  
        <div class="form-group">
         <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_for_consideration_amount_interest" class="form-control{{ $errors->has('claim_for_consideration_amount_interest') ? ' is-invalid' : '' }}" name="claim_for_consideration_amount_interest" value="{{$details->claim_for_consideration_amount_interest}}">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="sclaim_for_consideration_amount_withoutinterest"  name="claim_for_consideration_amount_withoutinterest" style="width:7%"  value="yes" {{ $details->claim_for_consideration_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
     </div>
   </div>
 </div>
 <div class="row">
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="sclaim_for_arrears_of_rent_maintenance_withoutinterest"  name="claim_for_arrears_of_rent_maintenance_withoutinterest" style="width:7%"  value="yes" {{ $details->claim_for_arrears_of_rent_maintenance_withoutinterest == 'yes' ? 'checked' : ''}}>
 </div>
</div>
</div>
<div class="row">
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="senforcement_of_mortgage_debt_amount" class="form-control{{ $errors->has('enforcement_of_mortgage_debt_amount') ? ' is-invalid' : '' }}" name="enforcement_of_mortgage_debt_amount"   value="{{ number_format((float)$details->enforcement_of_mortgage_debt_amount, 2, '.', '') }}" >
...
<div class="col-md-4">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="senforcement_of_mortgage_debt_amount_int" class="form-control{{ $errors->has('enforcement_of_mortgage_debt_amount_int') ? ' is-invalid' : '' }}" name="enforcement_of_mortgage_debt_amount_int"  value="{{$details->enforcement_of_mortgage_debt_amount_int}}">
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="senforcement_of_mortgage_debt_amount_withoutint"  name="enforcement_of_mortgage_debt_amount_withoutint" style="width:7%"  value="yes" {{ $details->enforcement_of_mortgage_debt_amount_withoutint == 'yes' ? 'checked' : ''}}>
 </div>
</div>
</div>
...
<div class="row">
  <div class="col-md-4"> 
    <div class="form-group">
     ...
     <input type="checkbox" class="form-control check-size" id="sclaim_for_contractual_built_up_or_land_share_area_select"  name="claim_for_contractual_built_up_or_land_share_area_select" style="width:7%"  value="yes" {{ $details->claim_for_contractual_built_up_or_land_share_area_select == 'yes' ? 'checked' : ''}}>
   </div>
 </div>
 <div class="col-md-4">  
  <div class="form-group">
   <input  type="text" id="sclaim_for_contractual_built_up_or_land_share_area" class="form-control{{ $errors->has('claim_for_contractual_built_up_or_land_share_area') ? ' is-invalid' : '' }}" name="claim_for_contractual_built_up_or_land_share_area"   value="{{$details->claim_for_contractual_built_up_or_land_share_area}}">
...
<div class="row">
  <div class="col-md-6"> 
    <div class="form-group">
     ...
     <input type="checkbox" class="form-control check-size" id="sredemption_of_mortgage"  name="redemption_of_mortgage" style="width:5%"  value="yes" {{ $details->redemption_of_mortgage == 'yes' ? 'checked' : ''}}>

   </div>
 </div>
 <div class="col-md-6">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="sredemption_of_mortgage_market_value_of_property" class="form-control{{ $errors->has('redemption_of_mortgage_market_value_of_property') ? ' is-invalid' : '' }}" name="redemption_of_mortgage_market_value_of_property"  value="{{ number_format((float)$details->redemption_of_mortgage_market_value_of_property, 2, '.', '') }}">
...
<div class="row">
 <div class="col-md-6"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="spossession_property"  name="possession_property" style="width:5%"  value="yes" {{ $details->possession_property == 'yes' ? 'checked' : ''}}>
 </div>
</div>
<div class="col-md-6">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="spossession_property_market_value" class="form-control{{ $errors->has('possession_property_market_value') ? ' is-invalid' : '' }}" name="possession_property_market_value"  value="{{ number_format((float)$details->possession_property_market_value, 2, '.', '') }}">
...
<div class="row">
  <div class="col-md-6"> 
    <div class="form-group">
     ...
     <input type="checkbox" class="form-control check-size" id="stermination_of_lease_mortgage_select"  name="termination_of_lease_mortgage_select" style="width:5%"   value="yes" {{ $details->termination_of_lease_mortgage_select == 'yes' ? 'checked' : ''}}>
   </div>
 </div>
 <div class="col-md-6">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="stermination_of_lease_mortgage_joint_development_agreement" class="form-control{{ $errors->has('termination_of_lease_mortgage_joint_development_agreement') ? ' is-invalid' : '' }}" name="termination_of_lease_mortgage_joint_development_agreement"  value="{{ number_format((float)$details->termination_of_lease_mortgage_joint_development_agreement, 2, '.', '') }}">
...
<div class="col-md-4">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="sdamage_amount_interest" class="form-control{{ $errors->has('damage_amount_interest') ? ' is-invalid' : '' }}" name="damage_amount_interest"   value="{{$details->damage_amount_interest}}">
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="sdamage_amount_interest_without"  name="damage_amount_interest_without" style="width:7%"  value="yes" {{ $details->damage_amount_interest_without == 'yes' ? 'checked' : ''}}>
 </div>
</div>
</div>
<div class="row">
 <div class="col-md-6">  
  <div class="form-group">
   ...
   <input typ="text" id="sspecific_perf" class="form-control{{ $errors->has('specific_perf') ? ' is-invalid' : '' }}" name="specific_perf" value="{{$details->specific_perf}}">
...
<div class="col-md-6">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="ssp_project_value" class="form-control{{ $errors->has('sp_project_value') ? ' is-invalid' : '' }}" name="sp_project_value"  value="{{ number_format((float)$details->sp_project_value, 2, '.', '') }}">
...
<div class="row">
  <div class="col-md-4">  
    <div class="form-group">
     <input type="text" id="sdivision_of_property_area" class="form-control{{ $errors->has('division_of_property_area') ? ' is-invalid' : '' }}" name="division_of_property_area"  value="{{$details->division_of_property_area}}">
...
<div class="col-md-4">  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"  id="sdivision_of_property_value" class="form-control{{ $errors->has('division_of_property_value') ? ' is-invalid' : '' }}" name="division_of_property_value"  value="{{ number_format((float)$details->division_of_property_value, 2, '.', '') }}">
...
<div class="col-md-4">  
  <div class="form-group">
   <input type="text" id="sdivision_of_property_unit" class="form-control{{ $errors->has('division_of_property_unit') ? ' is-invalid' : '' }}" name="division_of_property_unit"  value="{{$details->division_of_property_unit}}">

    ...
    <div class="row register-form" style="pointer-events: none;">
      ...
      <div class="row">
        <div class="col-md-4"> 
          <div class="form-group">
           ...
           <input type="text" id="sclaim_for_delivery_of_cargo" value="{{$details->claim_for_delivery_of_cargo}}" class="form-control{{ $errors->has('claim_for_delivery_of_cargo') ? ' is-invalid' : '' }}" name="claim_for_delivery_of_cargo" >
      ...
      <div class="col-md-4"> 
        <div class="form-group">
          <input type="text" id="scargo_nature" class="form-control{{ $errors->has('cargo_nature') ? ' is-invalid' : '' }}" name="cargo_nature" value="{{$details->cargo_nature}}" >
      ...
      <div class="col-md-4"> 
       <div class="form-group">
         <input type="text" id="snature_and_details_of_cargo" value="{{$details->nature_and_details_of_cargo}}" class="form-control{{ $errors->has('nature_and_details_of_cargo') ? ' is-invalid' : '' }}" name="nature_and_details_of_cargo" >
  ...
  <div class="row">
    <div class="col-md-4">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)" id="sclaim_for_payment_of_freight_amount"  value="{{ number_format((float)$details->claim_for_payment_of_freight_amount, 2, '.', '') }}" class="form-control{{ $errors->has('claim_for_payment_of_freight_amount') ? ' is-invalid' : '' }}" name="claim_for_payment_of_freight_amount" >
  ...
  <!-- <div class="col-md-4"> 
    <div class="form-group">
     <input type="text" id="sfreight_amount_interest" class="form-control{{ $errors->has('freight_amount_interest') ? ' is-invalid' : '' }}" value="{{$details->freight_amount_interest}}"  name="freight_amount_interest" >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="sfrightamountwithpoutinterest" class="form-control" style="width:7%" name="frightamountwithpoutinterest" onclick="document.getElementById('freight_amount_interest').disabled=this.checked;" >
...
<div class="row">
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text" id="sdamage_amount" value="{{$details->damage_amount}}" class="form-control{{ $errors->has('damage_amount') ? ' is-invalid' : '' }}" name="damage_amount" >
...
<div class="col-md-4"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)" id="sdamage_amount_interest" value="{{$details->damage_amount_interest}}" class="form-control{{ $errors->has('damage_amount_interest') ? ' is-invalid' : '' }}" name="damage_amount_interest" >
...
<div class="col-md-4"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)" id="sinterest_amount"  value="{{ number_format((float)$details->interest_amount, 2, '.', '') }}" class="form-control{{ $errors->has('interest_amount') ? ' is-invalid' : '' }}" name="interest_amount" >
...
<div class="row">
  <div class="col-md-6"> 
    <div class="form-group">
     <textarea id="sremarks" class="form-control{{ $errors->has('remarks') ? ' is-invalid' : '' }}" name="remarks"> 
      {{$details->remarks}}
     </textarea>
...
<div class="col-md-6"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)" id="sestimated_value_of_contract"  value="{{ number_format((float)$details->estimated_value_of_contract, 2, '.', '') }}" class="form-control{{ $errors->has('estimated_value_of_contract') ? ' is-invalid' : '' }}" name="estimated_value_of_contract" >

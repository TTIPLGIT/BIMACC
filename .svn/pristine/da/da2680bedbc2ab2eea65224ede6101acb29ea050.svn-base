<div class="row register-form" style="pointer-events: none;">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="claim_for_consideration_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_for_consideration_amount_withoutinterest" value="yes" {{ $details->claim_for_consideration_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="refund_withoutinterest" class="form-control check-size" style="width:7%" name="refund_withoutinterest" value="yes" {{ $details->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="claim_for_payment_of_damages_interest" class="form-control check-size" style="width:7%" name="claim_for_payment_of_damages_interest" value="yes" {{ $details->claim_for_payment_of_damages_interest == 'yes' ? 'checked' : ''}}>
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="value_performance_withoutint" class="form-control check-size" style="width:7%" name="value_performance_withoutint" value="yes" {{ $details->claim_for_payment_of_damages_interest == 'yes' ? 'checked' : ''}}>
 ...
 <div class="col-md-4"> 
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="value_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:7%" value="yes"  {{ $details->claim_for_consideration_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
  </div>

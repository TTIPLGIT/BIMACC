    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input type="date"  id="sdate_of_employment" class="datechk form-control{{ $errors->has('date_of_employment') ? ' is-invalid' : '' }}" name="date_of_employment"  value="{{$details->date_of_employment}}" >
    ...
    <div class="col-md-6"> 
      <div class="form-group">
        <input type="date"  id="sdate_of_consultancy_contract" class="datechk form-control{{ $errors->has('date_of_consultancy_contract') ? ' is-invalid' : '' }}" name="date_of_consultancy_contract"  value="{{$details->date_of_consultancy_contract}}">

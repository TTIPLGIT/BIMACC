  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="replacement_of_goods"  name="replacement_of_goods" style="width:9%" value="yes" {{ $details->replacement_of_goods == 'yes' ? 'checked' : ''}}>
  </div>
</div>
<div class="col-md-3"> 
  <div class="form-group">
     <label class="form-control-placeholder" for="redo_service" style="margin-left: 18px;">Redo the Service</label>
    <input type="checkbox" class="form-control check-size" id="redo_service"  name="redo_service" style="width:9%" value="yes" {{ $details->redo_service == 'yes' ? 'checked' : ''}}>
  </div>
</div>
...
<div class="col-md-3"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="damageamountinterestwithinterest"  name="damageamountinterestwithinterest" style="width:9%" value="yes" {{ $details->damageamountinterestwithinterest == 'yes' ? 'checked' : ''}}>
  </div>
</div>
</div>
<div class="row">

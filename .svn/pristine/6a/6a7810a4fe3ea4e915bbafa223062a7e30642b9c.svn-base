    ...
    <div class="row">
      <div class="col-md-6"> 
        <div class="form-group">
         ...
         <input type="text" id="sdetails_of_goods" class="form-control{{ $errors->has('details_of_goods') ? ' is-invalid' : '' }}" name="details_of_goods" value="{{$details->details_of_goods}}">
    ...
    <div class="col-md-6"> 
      <div class="form-group">
        <input type="text" id="sdetails_of_service" class="form-control{{ $errors->has('details_of_service') ? ' is-invalid' : '' }}" name="details_of_service" value="{{$details->details_of_service}}">
...
<div class="row">
  <div class="col-md-4">  
    <div class="form-group">
      <input type="date"  id="sdate_of_contract" name="date_of_contract"  class="datechk form-control{{ $errors->has('date_of_contract') ? ' is-invalid' : '' }}"  value="{{$details->date_of_contract}}">
  ...
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="date"  id="sdate_of_invoice" class="datechk form-control{{ $errors->has('date_of_invoice') ? ' is-invalid' : '' }}" name="date_of_invoice"  value="{{$details->date_of_invoice}}">
...
<div class="col-md-4"> 
  <div class="form-group">
   <input type="date"  id="sdate_of_warranty" class="datechk form-control{{ $errors->has('date_of_warranty') ? ' is-invalid' : '' }}" name="date_of_warranty" value="{{$details->date_of_warranty}}">
...
<div class="row">
 <div class="col-md-4"> 
  <div class="form-group">
   <input type="date"  id="sdate_of_breach" class="datechk form-control{{ $errors->has('date_of_breach') ? ' is-invalid' : '' }}" name="date_of_breach"  value="{{$details->date_of_breach}}">
...
<div class="col-md-4"> 
  <div class="form-group">
   <input type="date"  id="sdefault_date_of_cause_of_action" class="datechk form-control{{ $errors->has('default_date_of_cause_of_action') ? ' is-invalid' : '' }}" name="default_date_of_cause_of_action" value="{{$details->default_date_of_cause_of_action}}">
...
<div class="col-md-4"> 
  <div class="form-group">
   <input type="date"  id="sdate_of_notice" class="datechk form-control{{ $errors->has('date_of_notice') ? ' is-invalid' : '' }}" name="date_of_notice"  value="{{$details->date_of_notice}}">

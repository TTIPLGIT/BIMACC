...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="eid_claim_for_contract_price_withoutinterest" class="form-control check-size" style="width:7%" name="eid_claim_for_contract_price_withoutinterest"  value="yes" onclick="document.getElementById('eid_claim_for_contract_price_interest').disabled=this.checked;" >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="eid_claim_for_refund_withoutinterest" class="form-control check-size" style="width:7%" name="eid_claim_for_refund_withoutinterest" value="yes" onclick="document.getElementById('eid_claim_for_refund_interest').disabled=this.checked;" >
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="claim_for_escalation_of_costs_withoutinterest"  name="claim_for_escalation_of_costs_withoutinterest" style="width:7%" value="yes">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="claim_for_damages_withoutinterest"  name="claim_for_damages_withoutinterest" style="width:7%" value="yes">
  </div>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="to_terminate_contract"  name="to_terminate_contract" style="width:9%" value="yes">
  </div>
...
<div class="col-md-3"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="to_vacate_contractual_site"  name="to_vacate_contractual_site" style="width:9%" value="yes">
  </div>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="return_material_value"  name="return_material_value" style="width:9%" value="yes">
  </div>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="substitute_contractor"  name="substitute_contractor" style="width:7%" value="yes">
  </div>
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="eid_claim_for_contract_price_withoutinterest" class="form-control check-size" style="width:7%" name="eid_claim_for_contract_price_withoutinterest" value="yes" {{ $ReliefRequest->eid_claim_for_contract_price_withoutinterest == 'yes' ? 'checked' : ''}} >
...
<div class="col-md-4"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="eid_claim_for_refund_withoutinterest" style="margin-left: 18px;">Without Interest</label>
    <input type="checkbox" id="eid_claim_for_refund_withoutinterest" class="form-control check-size" style="width:7%" name="eid_claim_for_refund_withoutinterest" value="yes" {{ $ReliefRequest->eid_claim_for_refund_withoutinterest == 'yes' ? 'checked' : ''}}>
...
<div class="row">
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="claim_for_escalation_of_costs_withoutinterest" style="margin-left: 18px;">Without Interest</label>
    <input type="checkbox" class="form-control check-size" id="claim_for_escalation_of_costs_withoutinterest"  name="claim_for_escalation_of_costs_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->claim_for_escalation_of_costs_withoutinterest == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="claim_for_damages_withoutinterest" style="margin-left: 18px;">Without Interest</label>
    <input type="checkbox" class="form-control check-size" id="claim_for_damages_withoutinterest"  name="claim_for_damages_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->claim_for_damages_withoutinterest == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="to_terminate_contract" style="margin-left: 18px;">To Terminate Contract</label>
    <input type="checkbox" class="form-control check-size" id="to_terminate_contract"  name="to_terminate_contract" style="width:9%" value="yes" {{ $ReliefRequest->to_terminate_contract == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="col-md-3"> 
  <div class="form-group">
     <label class="form-control-placeholder" for="to_vacate_contractual_site" style="margin-left: 18px;">To Vacate Contractual Site</label>
    <input type="checkbox" class="form-control check-size" id="to_vacate_contractual_site"  name="to_vacate_contractual_site" style="width:9%" value="yes" {{ $ReliefRequest->to_vacate_contractual_site == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="return_material_value" style="margin-left: 18px;">Return Material</label>
    <input type="checkbox" class="form-control check-size" id="return_material_value"  name="return_material_value" style="width:9%" value="yes" {{ $ReliefRequest->return_material_value == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="substitute_contractor" style="margin-left: 18px;">Substitution of Contractor</label>
    <input type="checkbox" class="form-control check-size" id="substitute_contractor"  name="substitute_contractor" style="width:7%" value="yes" {{ $ReliefRequest->substitute_contractor == 'yes' ? 'checked' : ''}}>
  </div>

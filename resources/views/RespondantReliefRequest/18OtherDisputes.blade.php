...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="rclaim_for_consideration_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_for_consideration_amount_withoutinterest" value="yes" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="rrefund_withoutinterest" class="form-control check-size" style="width:7%" name="refund_withoutinterest" value="yes" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="rclaim_for_payment_of_damages_interest" class="form-control check-size" style="width:7%" name="claim_for_payment_of_damages_interest" value="yes" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="rvalue_performance_withoutint" class="form-control check-size" style="width:7%" name="value_performance_withoutint" value="yes" >

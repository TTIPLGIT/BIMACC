...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="rnature_of_property"  name="nature_of_property" style="width:9%"  value="yes"  >
       </div>
     </div>
  ...
  <div class="col-md-3"> 
    <div class="form-group">
     ...
     <input type="checkbox" class="form-control check-size" id="rdemand_for_licence_fee_withoutinterest"  name="demand_for_licence_fee_withoutinterest" style="width:9%"  value="yes"  >
   </div>
 </div>
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="rvalue_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:9%" value="yes">
 </div>
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="rdamages_for_breach_of_contract_withoutinterest"  name="damages_for_breach_of_contract_withoutinterest" style="width:9%"  value="yes">
 </div>
</div>
</div>
<div class="row">
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="rvalue_infringing_withoutinterest"  name="value_infringing_withoutinterest" style="width:9%"  value="yes">
 </div>
</div>

  ...
  <div class="row register-form">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="rfightrefundamountamountinterestwithinterest"  name="fightrefundamountamountinterestwithinterest" style="width:7%"  value="yes">
     </div>
   </div>
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="rfrightamountwithpoutinterest" class="form-control check-size" style="width:7%" name="frightamountwithpoutinterest" value="yes" >
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="rdamageamountinterestwithinterest"  name="damageamountinterestwithinterest" style="width:7%" value="yes">
 </div>
</div>
...
<div class="row">
 ...
 <div class="col-md-4"> 
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="rpayment_consideration_withoutinterest"  name="payment_consideration_withoutinterest" style="width:7%" value="yes">
  </div>

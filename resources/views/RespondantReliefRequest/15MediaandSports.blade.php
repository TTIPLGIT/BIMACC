    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="rmoney_claim_amount_withoutinterest"  name="money_claim_amount_withoutinterest" style="width:7%" value="yes" >
       </div>
     </div>
   ...
   <div class="row">
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="rclaim_for_withoutinterest"  name="claim_for_withoutinterest" style="width:7%" value="yes" >
       </div>
     </div>  
     </div> 
      <div class="row">
    ...
    <div class="col-md-4"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="rclaim_for_royalty_withoutinterest"  name="claim_for_royalty_withoutinterest" style="width:7%" value="yes" >
       </div>
     </div>  
     </div> 
     <div class="row">

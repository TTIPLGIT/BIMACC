  ...
  <div class="row register-form">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="rclaim_for_consideration_amount_withoutinterest"  name="claim_for_consideration_amount_withoutinterest" style="width:7%"  value="yes">
     </div>
   </div>
 </div>
 <div class="row">
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="rclaim_for_arrears_of_rent_maintenance_withoutinterest"  name="claim_for_arrears_of_rent_maintenance_withoutinterest" style="width:7%"  value="yes">
 </div>
</div>
</div>
<div class="row">
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="renforcement_of_mortgage_debt_amount_withoutint"  name="enforcement_of_mortgage_debt_amount_withoutint" style="width:7%"  value="yes">
 </div>
</div>
</div>
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="rdamage_amount_interest_without"  name="damage_amount_interest_without" style="width:7%"  value="yes">
 </div>
</div>
</div>
<div class="row">

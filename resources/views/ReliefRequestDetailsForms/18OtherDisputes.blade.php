...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="claim_for_consideration_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_for_consideration_amount_withoutinterest" value="yes" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="refund_withoutinterest" class="form-control check-size" style="width:7%" name="refund_withoutinterest" value="yes" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="claim_for_payment_of_damages_interest" class="form-control check-size" style="width:7%" name="claim_for_payment_of_damages_interest" value="yes" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="value_performance_withoutint" class="form-control check-size" style="width:7%" name="value_performance_withoutint" value="yes" >
...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_for_consideration_amount_withoutinterest" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" id="claim_for_consideration_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_for_consideration_amount_withoutinterest" value="yes" {{ $ReliefRequest->claim_for_consideration_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="refund_withoutinterest" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" id="refund_withoutinterest" class="form-control check-size" style="width:7%" name="refund_withoutinterest" value="yes" {{ $ReliefRequest->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="claim_for_payment_of_damages_interest" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" id="claim_for_payment_of_damages_interest" class="form-control check-size" style="width:7%" name="claim_for_payment_of_damages_interest" value="yes" {{ $ReliefRequest->claim_for_payment_of_damages_interest == 'yes' ? 'checked' : ''}}>
  ...
  <div class="form-group">
    <label class="form-control-placeholder" for="value_performance_withoutint" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" id="value_performance_withoutint" class="form-control check-size" style="width:7%" name="value_performance_withoutint" value="yes" {{ $ReliefRequest->claim_for_payment_of_damages_interest == 'yes' ? 'checked' : ''}}>
 ...
 <div class="col-md-4"> 
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="value_claims_withoutinterest" style="margin-left: 18px;" >Without Interest(%)</label>
    <input type="checkbox" class="form-control check-size" id="value_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:7%" value="yes"  {{ $ReliefRequest->claim_for_consideration_amount_withoutinterest == 'yes' ? 'checked' : ''}}>
  </div>

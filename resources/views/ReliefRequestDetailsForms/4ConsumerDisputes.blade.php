...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="replacement_of_goods"  name="replacement_of_goods" style="width:9%" value="yes">
  </div>
</div>
<div class="col-md-3"> 
  <div class="form-group">
     <label class="form-control-placeholder" for="redo_service" style="margin-left: 18px;">Redo the Service</label>
    <input type="checkbox" class="form-control check-size" id="redo_service"  name="redo_service" style="width:9%" value="yes">
  </div>
</div>
...
<div class="col-md-3"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="damageamountinterestwithinterest"  name="damageamountinterestwithinterest" style="width:9%" value="yes">
  </div>
</div>
</div>
<div class="row">
...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="replacement_of_goods" style="margin-left: 18px;">Replacement of Goods</label>
    <input type="checkbox" class="form-control check-size" id="replacement_of_goods"  name="replacement_of_goods" style="width:9%" value="yes" {{ $ReliefRequest->replacement_of_goods == 'yes' ? 'checked' : ''}}>
  </div>
</div>
<div class="col-md-3"> 
  <div class="form-group">
     <label class="form-control-placeholder" for="redo_service" style="margin-left: 18px;">Redo the Service</label>
    <input type="checkbox" class="form-control check-size" id="redo_service"  name="redo_service" style="width:9%" value="yes" {{ $ReliefRequest->redo_service == 'yes' ? 'checked' : ''}}>
  </div>
</div>
...
<div class="col-md-3"> 
  <div class="form-group">
     <label class="form-control-placeholder" for="damageamountinterestwithinterest" style="margin-left: 18px;">Without Interest </label>
    <input type="checkbox" class="form-control check-size" id="damageamountinterestwithinterest"  name="damageamountinterestwithinterest" style="width:9%" value="yes" {{ $ReliefRequest->damageamountinterestwithinterest == 'yes' ? 'checked' : ''}}>
  </div>
</div>
</div>
<div class="row">

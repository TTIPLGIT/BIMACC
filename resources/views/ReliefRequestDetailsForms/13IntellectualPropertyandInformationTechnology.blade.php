    ...
    <div class="col-md-12">
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="nature_of_property"  name="nature_of_property" style="width:9%"  value="yes"  >
       </div>
     </div>
...
<div class="row">
  <div class="col-md-3"> 
    <div class="form-group">
     ...
     <input type="checkbox" class="form-control check-size" id="cancellation_license"  name="cancellation_license" style="width:9%"  value="yes">
   </div>
 </div>
 <div class="col-md-4"> 
  <div class="form-group">
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="value_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:9%" value="yes">
 </div>
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="damages_for_breach_of_contract_withoutinterest"  name="damages_for_breach_of_contract_withoutinterest" style="width:9%"  value="yes">
 </div>
</div>
</div>
<div class="row">
 <div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="demand_to_surrender_infringed_materials"  name="demand_to_surrender_infringed_materials" style="width:9%"  value="yes">
 </div>
</div>
<div class="col-md-3"> 
  <div class="form-group">
...
<div class="col-md-3"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="value_infringing_withoutinterest"  name="value_infringing_withoutinterest" style="width:9%"  value="yes">
 </div>
</div>
  ...
  <div class="row register-form">
    <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-3"> 
          <div class="form-group">
           <label class="form-control-placeholder" for="demand_to_stop_infringement_select" style="margin-left: 18px;">Demand to Stop Infringement</label>
           <input type="checkbox" class="form-control check-size" id="demand_to_stop_infringement_select"  name="demand_to_stop_infringement_select" style="width:9%"  value="yes" {{ $ReliefRequest->demand_to_stop_infringement_select == 'yes' ? 'checked' : ''}}
           >
         </div>
       </div>
       <div class="col-md-3"> 
      ...
      <div class="col-md-3"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="nature_of_property" style="margin-left: 18px;">Without Interest</label>
         <input type="checkbox" class="form-control check-size" id="nature_of_property"  name="nature_of_property" style="width:9%"  value="yes" {{ $ReliefRequest->nature_of_property == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
   ...
   <div class="row">
     <div class="col-md-3"> 
      <div class="form-group">
       <label class="form-control-placeholder" for="demand_for_licence_fee" style="margin-left: 18px;">Demand for Licence Fee Amount:</label>
       <input type="checkbox" class="form-control check-size" id="demand_for_licence_fee"  name="demand_for_licence_fee" style="width:9%"  value="yes"  {{ $ReliefRequest->demand_for_licence_fee == 'yes' ? 'checked' : ''}}
       >
     </div>
   </div>
   <div class="col-md-3"> 
...
<div class="row">
  <div class="col-md-3"> 
    <div class="form-group">
     <label class="form-control-placeholder" for="cancellation_license" style="margin-left: 18px;margin-top: -8px;">Demand for Cancellation of License/ Assignment/ Agreement</label>
     <input type="checkbox" class="form-control check-size" id="cancellation_license"  name="cancellation_license" style="width:9%"  value="yes" {{ $ReliefRequest->cancellation_license == 'yes' ? 'checked' : ''}}
     >
   </div>
 </div>
 <div class="col-md-4"> 
...
<div class="col-md-3"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="value_claims_withoutinterest" style="margin-left: 18px;">Without Interest</label>
   <input type="checkbox" class="form-control check-size" id="value_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:9%" value="yes" {{ $ReliefRequest->value_claims_withoutinterest == 'yes' ? 'checked' : ''}}
   >
 </div>
...
<div class="col-md-3"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="damages_for_breach_of_contract_withoutinterest" style="margin-left: 18px;">Without Interest</label>
   <input type="checkbox" class="form-control check-size" id="damages_for_breach_of_contract_withoutinterest"  name="damages_for_breach_of_contract_withoutinterest" style="width:9%"  value="yes" {{ $ReliefRequest->damages_for_breach_of_contract_withoutinterest == 'yes' ? 'checked' : ''}}
   >
 </div>
</div>
</div>
<div class="row">
 <div class="col-md-3"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="demand_to_surrender_infringed_materials" style="margin-left: 18px;margin-top: -8px;">Demand to Surrender Infringing Material</label>
   <input type="checkbox" class="form-control check-size" id="demand_to_surrender_infringed_materials"  name="demand_to_surrender_infringed_materials" style="width:9%"  value="yes" {{ $ReliefRequest->demand_to_surrender_infringed_materials == 'yes' ? 'checked' : ''}}
   >
 </div>
</div>
<div class="col-md-3"> 
...
<div class="col-md-3"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="value_infringing_withoutinterest" style="margin-left: 18px;">Without Interest</label>
   <input type="checkbox" class="form-control check-size" id="value_infringing_withoutinterest"  name="value_infringing_withoutinterest" style="width:9%"  value="yes" {{ $ReliefRequest->value_infringing_withoutinterest == 'yes' ? 'checked' : ''}}
   >
 </div>
</div>

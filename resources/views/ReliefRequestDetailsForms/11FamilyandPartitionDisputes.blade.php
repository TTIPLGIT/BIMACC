  ...
  <div class="row register-form">
    ...
    <div class="col-md-4"> 
          <div class="form-group">
           ...
           <input type="checkbox" class="form-control check-size" id="rendition_of_accounts"  name="rendition_of_accounts" style="width:7%" value="yes">
         </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="rendition_and_distribution_of_mense_profits_withoutint"  name="rendition_and_distribution_of_mense_profits_withoutint" style="width:7%" value="yes">
     </div>
...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
  ...
  <div class="row register-form">
    ...
    <div class="col-md-4"> 
          <div class="form-group">
           <label class="form-control-placeholder" for="rendition_of_accounts" style="margin-left: 18px;">Rendition of Accounts</label>
           <input type="checkbox" class="form-control check-size" id="rendition_of_accounts"  name="rendition_of_accounts" style="width:7%" value="yes" {{ $ReliefRequest->rendition_of_accounts == 'yes' ? 'checked' : ''}}>
         </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       <label class="form-control-placeholder" for="rendition_and_distribution_of_mense_profits_withoutint" style="margin-left: 18px;">Without Interest</label>
       <input type="checkbox" class="form-control check-size" id="rendition_and_distribution_of_mense_profits_withoutint"  name="rendition_and_distribution_of_mense_profits_withoutint" style="width:7%" value="yes" {{ $ReliefRequest->rendition_and_distribution_of_mense_profits_withoutint == 'yes' ? 'checked' : ''}}>
     </div>

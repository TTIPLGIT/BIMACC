...
<form  name="reliefrequest_form" id="reliefrequest_form" method="POST" >
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="claim_reinstatement"  name="claim_reinstatement" style="width:5%"  value="yes">
  </div>
</div>
      <div class="col-md-6">  
        <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="benefit_withoutinterest"  name="benefit_withoutinterest" style="width:9%"  value="yes">
  </div>
</div>
...
<div class="col-md-3"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="restraint"  name="restraint" style="width:10%"  value="yes">
  </div>
...
<div class="col-md-3"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="termination"  name="termination" style="width:10%"  value="yes">
  </div>
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="average_value_withoutinterest"  name="average_value_withoutinterest" style="width:7%" value="yes">
  </div>
...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
 ...
 <div class="row register-form">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="claim_reinstatement"  name="claim_reinstatement" style="width:5%"  value="yes" {{ $ReliefRequest->claim_reinstatement == 'yes' ? 'checked' : ''}}>
  </div>
</div>
<div class="col-md-6">  
        <div class="form-group">
...
<div class="col-md-3"> 
  <div class="form-group">
     <label class="form-control-placeholder" for="termination" style="margin-left: 18px;">Termination </label>
    <input type="checkbox" class="form-control check-size" id="termination"  name="termination" style="width:10%"  value="yes" {{ $ReliefRequest->termination == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="col-md-4"> 
  <div class="form-group">
     <label class="form-control-placeholder" for="average_value_withoutinterest" style="margin-left: 18px;">Without interest</label>
    <input type="checkbox" class="form-control check-size" id="average_value_withoutinterest"  name="average_value_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequest->average_value_withoutinterest == 'yes' ? 'checked' : ''}}>
  </div>

  ...
  <div class="row register-form">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="fightrefundamountamountinterestwithinterest"  name="fightrefundamountamountinterestwithinterest" style="width:7%"  value="yes">
     </div>
   </div>
 ...
 <div class="row">
   <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="claim_for_delivery_of_cargo"  name="claim_for_delivery_of_cargo" style="width:7%" value="yes" >
     </div>
   </div>
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="frightamountwithpoutinterest" class="form-control check-size" style="width:7%" name="frightamountwithpoutinterest" value="yes" >
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="damageamountinterestwithinterest"  name="damageamountinterestwithinterest" style="width:7%" value="yes">
 </div>
</div>
...
<div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="termination_of_contract"  name="termination_of_contract" style="width:10%"  value="yes">
       </div>
     </div>
<div class="col-md-3"> 
  <div class="form-group">
...
<div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="return_of_property"  name="return_of_property" style="width:10%"  value="yes">
       </div>
     </div>
<div class="col-md-3"> 
  <div class="form-group">
...
<div class="row">
 ...
 <div class="col-md-4"> 
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="payment_consideration_withoutinterest"  name="payment_consideration_withoutinterest" style="width:7%" value="yes">
  </div>
...
<form  name="reliefrequest_update_form" id="reliefrequest_update_form" method="POST" >
  ...
  <div class="row register-form">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       <label class="form-control-placeholder" for="fightrefundamountamountinterestwithinterest" style="margin-left: 18px;">Without Interest</label>
       <input type="checkbox" class="form-control check-size" id="fightrefundamountamountinterestwithinterest"  name="fightrefundamountamountinterestwithinterest" style="width:7%" value="yes"  {{$ReliefRequests->fightrefundamountamountinterestwithinterest == 'yes' ? 'checked' : ''}}>
     </div>
   </div>
 ...
 <div class="row">
   <div class="col-md-4"> 
      <div class="form-group">
       <label class="form-control-placeholder" for="claim_for_delivery_of_cargo" style="margin-left: 18px;">Claim for delivery of cargo/baggage</label>
       <input type="checkbox" class="form-control check-size" id="claim_for_delivery_of_cargo"  name="claim_for_delivery_of_cargo" style="width:7%" value="yes" {{ $ReliefRequests->claim_for_delivery_of_cargo == 'yes' ? 'checked' : ''}}>
     </div>
   </div>
...
<div class="col-md-4"> 
  <div class="form-group">
    <label class="form-control-placeholder" for="frightamountwithpoutinterest" style="margin-left: 18px;">Without Interest</label>
    <input type="checkbox" id="frightamountwithpoutinterest" class="form-control check-size" style="width:7%" name="frightamountwithpoutinterest" value="yes" {{ $ReliefRequests->frightamountwithpoutinterest == 'yes' ? 'checked' : ''}} >
...
<div class="col-md-4"> 
  <div class="form-group">
   <label class="form-control-placeholder" for="damageamountinterestwithinterest" style="margin-left: 18px;">Without Interest</label>
   <input type="checkbox" class="form-control check-size" id="damageamountinterestwithinterest"  name="damageamountinterestwithinterest" style="width:7%" value="yes" {{ $ReliefRequests->damageamountinterestwithinterest == 'yes' ? 'checked' : ''}}>
 </div>
</div>
...
<div class="row">
      ...
      <div class="col-md-4"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="claim_for_demurrages_withoutinterest" style="margin-left: 18px;">Without Interest</label>
         <input type="checkbox" class="form-control check-size" id="claim_for_demurrages_withoutinterest"  name="claim_for_demurrages_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequests->claim_for_demurrages_withoutinterest == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
   </div>
   <div class="row">
...
<div class="col-md-3"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="termination_of_contract" style="margin-left: 26px;">Termination of Contract</label>
         <input type="checkbox" class="form-control check-size" id="termination_of_contract"  name="termination_of_contract" style="width:10%"  value="yes" {{ $ReliefRequests->termination_of_contract == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
<div class="col-md-3"> 
  <div class="form-group">
...
<div class="col-md-3"> 
        <div class="form-group">
         <label class="form-control-placeholder" for="return_of_property" style="margin-left: 26px;">Return of Property</label>
         <input type="checkbox" class="form-control check-size" id="return_of_property"  name="return_of_property" style="width:10%"  value="yes" {{ $ReliefRequests->return_of_property == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
<div class="col-md-3"> 
  <div class="form-group">
...
<div class="row">
 ...
 <div class="col-md-4"> 
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="payment_consideration_withoutinterest" style="margin-left: 18px;">Without Interest</label>
    <input type="checkbox" class="form-control check-size" id="payment_consideration_withoutinterest"  name="payment_consideration_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequests->payment_consideration_withoutinterest == 'yes' ? 'checked' : ''}} >
  </div>
...
<div class="row">
 ...
 <div class="col-md-4"> 
  ...
  <div class="form-group">
     <label class="form-control-placeholder" for="value_claims_withoutinterest" style="margin-left: 18px;">Without Interest</label>
    <input type="checkbox" class="form-control check-size" id="value_claims_withoutinterest"  name="value_claims_withoutinterest" style="width:7%" value="yes" {{ $ReliefRequests->value_claims_withoutinterest == 'yes' ? 'checked' : ''}} >
  </div>

    ...
    <div class="row">
      <div class="col-md-6">  
        <div class="form-group">
         <input type="text" onkeypress="return isNumberKey(event)"id="sescalation_of_costs" class="form-control{{ $errors->has('escalation_of_costs') ? ' is-invalid' : '' }}" name="escalation_of_costs"  value="{{ number_format((float)$details->escalation_of_costs, 2, '.', '') }}">
      ...
      <div class="col-md-6">  
      <div class="form-group">
       <input type="text" id="sclaim_for_damages" class="form-control{{ $errors->has('claim_for_damages') ? ' is-invalid' : '' }}" name="claim_for_damages" value="{{ $details->claim_for_damages }}">
...
<div class="col-md-1"><input class="form-control" value="{{$count_in}}"  type="text" disabled ><label class="form-control-placeholder">Sl. No.</label></div>
  <div class="col-md-5">  
    <div class="form-group" >
     <input type="text" onkeypress="return isNumberKey(event)"  id="scontract_price1" value="{{ number_format((float)$contract_reliefs->contract_price, 2, '.', '') }}" class="form-control{{ $errors->has('contract_price') ? ' is-invalid' : '' }}"  readonly >
...
<div class="col-md-6" >  
  <div class="form-group">
   <input type="text" onkeypress="return isNumberKey(event)"id="sclaim_for_refund_lines1" class="form-control{{ $errors->has('claim_for_refund_lines') ? ' is-invalid' : '' }}" value="{{ number_format((float)$contract_reliefs->claim_for_refund_lines, 2, '.', '') }}" readonly >
...
<div class="row">
  <div class="col-md-6">
    <div class="form-group">
      <input type="text" id="sspecific_performance_of_contract" value="{{$details->specific_performance_of_contract}}" class="form-control{{ $errors->has('specific_performance_of_contract') ? ' is-invalid' : '' }}" name="specific_performance_of_contract" >
  ...
  <div class="col-md-6">
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="sspecific_estimated_value_of_contract" class="form-control{{ $errors->has('specific_estimated_value_of_contract') ? ' is-invalid' : '' }}" name="specific_estimated_value_of_contract" value="{{ number_format((float)$details->specific_estimated_value_of_contract, 2, '.', '') }}" >
...
<div class="row">
  <div class="col-md-6">
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"  id="stocancel_estimated_value_of_contract" class="form-control{{ $errors->has('tocancel_estimated_value_of_contract') ? ' is-invalid' : '' }}" name="tocancel_estimated_value_of_contract" value="{{ number_format((float)$details->tocancel_estimated_value_of_contract, 2, '.', '') }}">
...
<div class="row">
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text"  onkeypress="return isNumberKey(event)"  id="sclaim_for_contract_price" value="{{ $details->claim_for_contract_price }}" class="form-control{{ $errors->has('claim_for_contract_price') ? ' is-invalid' : '' }}" name="claim_for_contract_price" >
...
<div class="col-md-4"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_for_contract_price_interest" value="{{$details->claim_for_contract_price_interest}}" class="form-control{{ $errors->has('claim_for_contract_price_interest') ? ' is-invalid' : '' }}" name="claim_for_contract_price_interest" >
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="srefund_withoutinterest"  name="refund_withoutinterest" style="width:7%" value="yes" {{ $details->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
 </div>
</div>

  ...
  <div class="row">
    <div class="col-md-4">  
      <div class="form-group">
       ...
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_subs_contrib_amount" class="form-control{{ $errors->has('claim_subs_contrib_amount') ? ' is-invalid' : '' }}" name="claim_subs_contrib_amount"   value="{{ number_format((float)$details->claimamount, 2, '.', '') }}">
  ...
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_subs_contrib_amount_interest" class="form-control{{ $errors->has('claim_subs_contrib_amount_interest') ? ' is-invalid' : '' }}" name="claim_subs_contrib_amount_interest"   value="{{$details->claim_subs_contrib_amount_interest}}">
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_subs_contrib_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_subs_contrib_amount_withoutinterest" value="yes" {{ $details->claim_subs_contrib_amount_withoutinterest == 'yes' ? 'checked' : ''}} >
...
<div class="row">
  <div class="col-md-4"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="sinterest_amount"  class="form-control{{ $errors->has('interest_amount') ? ' is-invalid' : '' }}" name="interest_amount" value="{{ number_format((float)$details->claimamount, 2, '.', '') }}">
...
<div class="row">
    ...
    <div class="col-md-4">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_refund_deposit_amount" class="form-control{{ $errors->has('claim_refund_deposit_amount') ? ' is-invalid' : '' }}" name="claim_refund_deposit_amount"  value="{{ number_format((float)$details->claim_refund_deposit_amount, 2, '.', '') }}">
        @if ($claimantinformations[0]->currency =='INR') 
  ...
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_refund_deposit_amount_interest" class="form-control{{ $errors->has('claim_refund_deposit_amount_interest') ? ' is-invalid' : '' }}" name="claim_refund_deposit_amount_interest"  value="{{$details->claim_refund_deposit_amount_interest}}">
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_refund_deposit_amount_withoutinterest" class="form-control check-size" style="width:7%" name="claim_refund_deposit_amount_withoutinterest" value="yes" {{ $details->claim_refund_deposit_amount_withoutinterest == 'yes' ? 'checked' : ''}} >
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_for_admission_and_removal_of_members_check" class="form-control check-size" style="width:9%" name="claim_for_admission_and_removal_of_members_check" value="yes" {{ $details->claim_for_admission_and_removal_of_members_check == 'yes' ? 'checked' : ''}} >
    
  </div>
</div>
    <div class="col-md-3">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_for_admission_and_removal_of_members" class="form-control{{ $errors->has('claim_for_admission_and_removal_of_members') ? ' is-invalid' : '' }}" name="claim_for_admission_and_removal_of_members" value="{{ number_format((float)$details->claim_for_admission_and_removal_of_members, 2, '.', '') }}">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_to_remove_or_reinstate_office_bearers_check" class="form-control check-size" style="width:9%" name="claim_to_remove_or_reinstate_office_bearers_check" value="yes" {{ $details->claim_to_remove_or_reinstate_office_bearers_check == 'yes' ? 'checked' : ''}} >
    
  </div>
</div>
  <div class="col-md-3">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_to_remove_or_reinstate_office_bearers" class="form-control{{ $errors->has('claim_to_remove_or_reinstate_office_bearers') ? ' is-invalid' : '' }}" name="claim_to_remove_or_reinstate_office_bearers" value="{{ number_format((float)$details->claim_to_remove_or_reinstate_office_bearers, 2, '.', '') }}">
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_for_holding_or_postponement_of_elections_check" class="form-control check-size" style="width:9%" name="claim_for_holding_or_postponement_of_elections_check" value="yes" {{ $details->claim_for_holding_or_postponement_of_elections_check == 'yes' ? 'checked' : ''}} >
    
  </div>
</div>
    <div class="col-md-3">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_for_holding_or_postponement_of_elections" class="form-control{{ $errors->has('claim_for_holding_or_postponement_of_elections') ? ' is-invalid' : '' }}" name="claim_for_holding_or_postponement_of_elections" value="{{ number_format((float)$details->claim_for_holding_or_postponement_of_elections, 2, '.', '') }}">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_to_appoint_auditors_or_investigators_check" class="form-control check-size" style="width:9%" name="claim_to_appoint_auditors_or_investigators_check" value="yes" {{ $details->claim_to_appoint_auditors_or_investigators_check == 'yes' ? 'checked' : ''}} >
    
  </div>
</div>
  <div class="col-md-3">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_to_appoint_auditors_or_investigators" class="form-control{{ $errors->has('claim_to_appoint_auditors_or_investigators') ? ' is-invalid' : '' }}" name="claim_to_appoint_auditors_or_investigators" value="{{ number_format((float)$details->claim_to_appoint_auditors_or_investigators, 2, '.', '') }}">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_to_appoint_auditors_check" class="form-control check-size" style="width:9%" name="claim_to_appoint_auditors_check" value="yes" {{ $details->claim_to_appoint_auditors_check == 'yes' ? 'checked' : ''}} >
    
  </div>
</div>
    <div class="col-md-3">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_to_appoint_auditors" class="form-control{{ $errors->has('claim_to_appoint_auditors') ? ' is-invalid' : '' }}" name="claim_to_appoint_auditors" value="{{ number_format((float)$details->claim_to_appoint_auditors, 2, '.', '') }}">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_to_render_accounts_check" class="form-control check-size" style="width:9%" name="claim_to_render_accounts_check" value="yes" {{ $details->claim_to_render_accounts_check == 'yes' ? 'checked' : ''}} >
    
  </div>
</div>
  <div class="col-md-3">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_to_render_accounts" class="form-control{{ $errors->has('claim_to_render_accounts') ? ' is-invalid' : '' }}" name="claim_to_render_accounts"  value="{{ number_format((float)$details->claim_to_render_accounts, 2, '.', '') }}">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_against_members_for_damages_and_nuisance_check" class="form-control check-size" style="width:9%" name="claim_against_members_for_damages_and_nuisance_check" value="yes" {{ $details->claim_against_members_for_damages_and_nuisance_check == 'yes' ? 'checked' : ''}} >
    
  </div>
</div>
    <div class="col-md-3">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_against_members_for_damages_and_nuisance" class="form-control{{ $errors->has('claim_against_members_for_damages_and_nuisance') ? ' is-invalid' : '' }}" name="claim_against_members_for_damages_and_nuisance" value="{{ number_format((float)$details->claim_against_members_for_damages_and_nuisance, 2, '.', '') }}">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="sclaim_to_carryout_repairs_or_renovation_check" class="form-control check-size" style="width:9%" name="claim_to_carryout_repairs_or_renovation_check" value="yes" {{ $details->claim_to_carryout_repairs_or_renovation_check == 'yes' ? 'checked' : ''}} >
    
  </div>
</div>
  <div class="col-md-3">  
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_to_carryout_repairs_or_renovation" class="form-control{{ $errors->has('claim_to_carryout_repairs_or_renovation') ? ' is-invalid' : '' }}" name="claim_to_carryout_repairs_or_renovation"  value="{{ number_format((float)$details->claim_to_carryout_repairs_or_renovation, 2, '.', '') }}">

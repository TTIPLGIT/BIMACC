  <div class="row register-form" style="pointer-events: none;">
    ...
    <div class="col-md-3"> 
      <div class="form-group">
       ...
       <input type="text" id="snature_of_goods" class="form-control{{ $errors->has('nature_of_goods') ? ' is-invalid' : '' }}" name="nature_of_goods"  value="{{$details->nature_of_goods}}" >
  ...
  <div class="col-md-3"> 
    <div class="form-group">
      <input type="text" onkeypress="return isNumberKey(event)"id="squantity_of_goods"  class="form-control{{ $errors->has('quantity_of_goods') ? ' is-invalid' : '' }}" name="quantity_of_goods" value="{{$details->quantity_of_goods}}">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="sreplacement_of_goods"  name="replacement_of_goods" style="width:9%" value="yes" {{ $details->replacement_of_goods == 'yes' ? 'checked' : ''}}>
  </div>
</div>
<div class="col-md-3"> 
  <div class="form-group">
     <label class="form-control-placeholder" for="redo_service" style="margin-left: 18px;">Redo the Service</label>
    <input type="checkbox" class="form-control check-size" id="sredo_service"  name="redo_service" style="width:9%" value="yes" {{ $details->redo_service == 'yes' ? 'checked' : ''}}>
  </div>
</div>
...
<div class="row">
  <div class="col-md-3"> 
    <div class="form-group">      
     <input type="text" onkeypress="return isNumberKey(event)" id="srefund_of_price"  class="form-control{{ $errors->has('refund_of_price') ? ' is-invalid' : '' }}" value="{{ number_format((float)$details->refund_of_price, 2, '.', '') }}"> 
...
<div class="col-md-3"> 
  <div class="form-group">    
    ...
    <input type="text" onkeypress="return isNumberKey(event)" id="sprice_of_goods"  class="form-control{{ $errors->has('price_of_goods') ? ' is-invalid' : '' }}" name="price_of_goods"value="{{ number_format((float)$details->price_of_goods, 2, '.', '') }}" >  
    @if ($claimantinformations[0]->currency =='INR') 
...
<div class="col-md-3"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)" id="sprice_of_goods_interest" class="form-control{{ $errors->has('price_of_goods_interest') ? ' is-invalid' : '' }}" name="price_of_goods_interest"  value="{{$details->price_of_goods_interest}}">
...
<div class="col-md-3"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="sdamageamountinterestwithinterest"  name="damageamountinterestwithinterest" style="width:9%" value="yes" {{ $details->damageamountinterestwithinterest == 'yes' ? 'checked' : ''}}>
  </div>
</div>
</div>
<div class="row">
<div class="col-md-4"> 
  <div class="form-group">
    <input type="text" id="sdamages" class="form-control{{ $errors->has('damages') ? ' is-invalid' : '' }}" name="damages"  value="{{$details->damages}}">

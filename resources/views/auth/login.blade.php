...
<div class="limiter">
    ...
    <div class="container">
        <div class="row" class="main_row">
            <div class="col-lg-12 text-center">
                <img src="http://localhost:10/bimacc/public/images/pic.png" class="img-responsive" width="220px">
            </div>
        </div>
    </div>
    ...
    <div class="login1">
        ...
        ">If you don’t have an account</h4>
                <a class="login100-form-btnnew" title="Register" href="{{ route('claimantregister.create') }}"
                    style="background: #602e9e !important;">{{ __('Please Register') }}</a>
            </div>
        </div>
    </div>

    <div class="container-login101">
        <img src="http://localhost:10/bimacc/public/images/login_page1.jpg" class="loginimg">
        <form method="POST" action="{{ route('login_form') }}" class="login101-form validate-form" autocomplete="off">
            ...
            <div class="wrap-input100 validate-input m-b-10" data-validate="Username is required">
                ...
                <input id="email" type="text"
                    class="input101 form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email"
                    placeholder="Enter Email ID or Mobile Number" value="{{ old('email') }}" required autofocus>
        ...
        <img src="{{ url(asset('images/usericon.png')) }}" class="inputicon" />
            ...
            <div class="wrap-input100 validate-input m-b-10" data-validate="Password is required">
                <input type="password" placeholder="Enter Password"
                    class="input101 form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password"
                    required>
    ...
    <img src="{{ url(asset('images/passicon.png')) }}" class="inputicon" />
        ...
        {{ __('') }}
                ...
                <button type="submit" class="login101-form-btn">
                    <div><img src="{{ url(asset('images/Layer3.png')) }}" class="imgicon" /></div>
                    {{ __('') }}
                </button>

                @if (Route::has('password.request'))
                <a class="text-center w-full p-t-25 p-b-0 txt2 btn btn-link" href="{{ route('password.request') }}"
  ...
  ">Submit</button> -->
    ...
    <div style="width: 100%">
        ...
        <div class="footercredits">
            ...
            <div><a href="{{url('privacypolicy')}}" target="blank" style="color: #602e9e"> &nbsp;<b>Privacy Policy
                    </b>&nbsp;</a>
                <p>&nbsp;&nbsp;|&nbsp;&nbsp;</p>
                <i class="fa fa-copyright" style="color: black; "></i>
                <p style="color: #602e9e;font-weight: bold">{{ now()->year }} <a
                        href="{{url('https://www.bimacc.org/')}}" target="blank" style="color: #602e9e">
                        &nbsp;Lexquisite. &nbsp;</a> &nbsp; All Rights Reserved. &nbsp; </p>|</p><a
                    href="{{url('about_us')}}" target="blank" style="color: #602e9e"> &nbsp;<b>About Us </b>&nbsp;</a>
                </p>|</p> <a href="{{url('mainscreen')}}" target="blank" style="color: #602e9e"> &nbsp;<b>FAQ
                    </b>&nbsp;</a>|</p> <a href="{{url('terms')}}" target="blank" style="color: #602e9e"> &nbsp;<b>Terms
                        & Conditions </b>&nbsp;</a>
            </div>|</p><a href="" data-toggle="modal" data-target="#contactusmodal" style="color: #602e9e">
                &nbsp;<b>Contact Us</b>&nbsp;</a>|</p><a
                href="http://localhost:10/bimacc_production/storage/app/public/uploads/usermanual/eAs_User_Manual.pdf"
                download style="color: #602e9e"> &nbsp;<b>User Manual</b>&nbsp;</a>
        </div>
...
$('form').on('submit', function(e) {
    ...
    $.ajax({
        ...
        if (count_mail == '0') {
            ...
            if ((count_mail == '1' && count_claimant1 != '0') || (count_mail == '1' &&
                    count_claimant1 == '0')) {
                if (verify_count == '0') {
                ...
                for (var count = 0; count < role.length; count++) {
                    html += '<input type="radio" name="role_pop" value="' + role[count].roles_id +
                        '" mail_ver="' + role[count].mail_verify + '"> <label for="male">' + role[count]
                        .display_name + '</label><input type="text" name="mail_verify" value="' + role[
                            count].mail_verify + '" style="display: none;"> <label></label></br>';

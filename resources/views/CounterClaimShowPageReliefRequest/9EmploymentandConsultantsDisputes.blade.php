 <div class="row register-form" style="pointer-events: none;">
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="claim_reinstatement"  name="claim_reinstatement" style="width:5%"  value="yes" {{ $details->claim_reinstatement == 'yes' ? 'checked' : ''}}>
  </div>
</div>
<div class="col-md-6">  
        <div class="form-group">
...
<div class="col-md-3"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="termination"  name="termination" style="width:10%"  value="yes" {{ $details->termination == 'yes' ? 'checked' : ''}}>
  </div>
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="average_value_withoutinterest"  name="average_value_withoutinterest" style="width:7%" value="yes" {{ $details->average_value_withoutinterest == 'yes' ? 'checked' : ''}}>
  </div>

  <div class="row register-form" style="pointer-events: none;">
    ...
    <div class="col-md-4"> 
          <div class="form-group">
           ...
           <input type="checkbox" class="form-control check-size" id="rendition_of_accounts"  name="rendition_of_accounts" style="width:7%" value="yes" {{ $details->rendition_of_accounts == 'yes' ? 'checked' : ''}}>
         </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="rendition_and_distribution_of_mense_profits_withoutint"  name="rendition_and_distribution_of_mense_profits_withoutint" style="width:7%" value="yes" {{ $details->rendition_and_distribution_of_mense_profits_withoutint == 'yes' ? 'checked' : ''}}>
     </div>

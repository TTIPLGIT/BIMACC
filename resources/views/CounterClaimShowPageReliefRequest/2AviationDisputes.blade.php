   ...
   <div class="row">
    ...
    <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="fightrefundamountamountinterestwithinterest"  name="fightrefundamountamountinterestwithinterest" style="width:7%" value="yes"  {{$details->fightrefundamountamountinterestwithinterest == 'yes' ? 'checked' : ''}}>
     </div>
   </div>
 ...
 <div class="row">
   <div class="col-md-4"> 
      <div class="form-group">
       ...
       <input type="checkbox" class="form-control check-size" id="claim_for_delivery_of_cargo"  name="claim_for_delivery_of_cargo" style="width:7%" value="yes" {{ $details->claim_for_delivery_of_cargo == 'yes' ? 'checked' : ''}}>
     </div>
   </div>
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" id="frightamountwithpoutinterest" class="form-control check-size" style="width:7%" name="frightamountwithpoutinterest" value="yes" {{ $details->frightamountwithpoutinterest == 'yes' ? 'checked' : ''}} >
...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="damageamountinterestwithinterest"  name="damageamountinterestwithinterest" style="width:7%" value="yes" {{ $details->damageamountinterestwithinterest == 'yes' ? 'checked' : ''}}>
 </div>
</div>
...
<div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="termination_of_contract"  name="termination_of_contract" style="width:10%"  value="yes" {{ $details->termination_of_contract == 'yes' ? 'checked' : ''}}>
       </div>
     </div>
<div class="col-md-3"> 
  <div class="form-group">
...
<div class="col-md-3"> 
        <div class="form-group">
         ...
         <input type="checkbox" class="form-control check-size" id="return_of_property"  name="return_of_property" style="width:10%"  value="yes" {{ $details->return_of_property == 'yes' ? 'checked' : ''}} >
       </div>
     </div>
<div class="col-md-3"> 
  <div class="form-group">
...
<div class="row">
 ...
 <div class="col-md-4"> 
  ...
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="payment_consideration_withoutinterest"  name="payment_consideration_withoutinterest" style="width:7%" value="yes" {{ $details->payment_consideration_withoutinterest == 'yes' ? 'checked' : ''}} >
  </div>

...
<div class="col-md-4"> 
  <div class="form-group">
   ...
   <input type="checkbox" class="form-control check-size" id="refund_withoutinterest"  name="refund_withoutinterest" style="width:7%" value="yes" {{ $details->refund_withoutinterest == 'yes' ? 'checked' : ''}}>
 </div>
</div>

...
<div class="col-md-1"><input class="form-control" value="{{$count_in}}"  type="text" disabled ><label class="form-control-placeholder">Sl. No.</label></div>
    ...
    <div class="col-md-3"> 
      <div class="form-group">
       <input type="date"  id="sdate_insurance" class="datechk form-control{{ $errors->has('date_insurance') ? ' is-invalid' : '' }}"  value="{{$insurance_claims->date_insurance}}" readonly>
...
<div class="row">
 <div class="col-md-3">  
  <div class="form-group">
    <input type="date"  id="spolicy_maturity_date"   class="datechk form-control{{ $errors->has('policy_maturity_date') ? ' is-invalid' : '' }}" value="{{$insurance_claims->policy_maturity_date}}" readonly>
...
<div class="row">
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="date"  id="sdate_of_claim" class="datechk form-control{{ $errors->has('date_of_claim') ? ' is-invalid' : '' }}"  value="{{$insurance_claims->date_of_claim}}" readonly>
...
<div class="col-md-4">  
  <div class="form-group">
    <input type="date"  id="sdate_of_notice_insurance"   class="datechk form-control{{ $errors->has('date_of_notice_insurance') ? ' is-invalid' : '' }}" value="{{$insurance_claims->date_of_notice_insurance}}" readonly>
...
<div class="col-md-4">  
  <div class="form-group">
    <input type="date"  id="sdate_of_breach_insurance"   class="datechk form-control{{ $errors->has('date_of_breach_insurance') ? ' is-invalid' : '' }}" value="{{$insurance_claims->date_of_breach_insurance}}" readonly>
...
<div class="col-md-4"> 
  <div class="form-group">
   <input type="date"  id="sdate_document" class="datechk form-control{{ $errors->has('date_document') ? ' is-invalid' : '' }}"  value="{{$insurance_claims->date_document}}" readonly>

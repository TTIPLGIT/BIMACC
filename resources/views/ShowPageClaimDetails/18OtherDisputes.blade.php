    ...
    <div class="col-md-12" style="pointer-events: none;">
         ...
         <div class="row">
           <div class="col-md-4"> 
            <div class="form-group">
             <input type="date"  id="ssdate_of_contract" class="datechk form-control{{ $errors->has('date_of_contract') ? ' is-invalid' : '' }}" name="date_of_contract" value="{{$details->date_of_contract}}">
        ...
        <div class="col-md-4"> 
            <div class="form-group">
             <input type="text"  onkeypress="return isNumberKey(event)"  id="scontractdate" class="form-control{{ $errors->has('contractdate') ? ' is-invalid' : '' }}" name="contractdate" value="{{ number_format((float)$details->contractdate, 2, '.', '') }}">
        ...
        <div class="col-md-4"> 
            <div class="form-group">
             <input type="text" id="snature_of_breach" class="form-control{{ $errors->has('nature_of_breach') ? ' is-invalid' : '' }}" name="nature_of_breach" value="{{$details->nature_of_breach}}">
      ...
      <div class="row">
        <div class="col-md-4"> 
            <div class="form-group">
             <input type="date"  id="ssdate_of_breach" class="datechk form-control{{ $errors->has('date_of_breach') ? ' is-invalid' : '' }}" name="date_of_breach" value="{{$details->date_of_breach}}">
        ...
        <div class="col-md-4"> 
            <div class="form-group">
             <input type="date"  id="ssdate_of_notice" class="datechk form-control{{ $errors->has('date_of_notice') ? ' is-invalid' : '' }}" name="date_of_notice" value="{{$details->date_of_notice}}">

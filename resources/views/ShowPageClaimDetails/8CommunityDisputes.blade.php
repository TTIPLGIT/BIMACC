    ...
    <div class="col-md-6"> 
      <div class="form-group">
        <input type="text" id="sdetails_of_documents" class="form-control{{ $errors->has('details_of_documents') ? ' is-invalid' : '' }}" name="details_of_documents"  value="{{$details->details_of_documents}}">
  ...
  <div class="row">
    <div class="col-md-6">  
      <div class="form-group">
        <input type="date"  id="sdate_of_breach" name="date_of_breach"  class="datechk form-control{{ $errors->has('date_of_breach') ? ' is-invalid' : '' }}"  value="{{$details->date_of_breach}}">

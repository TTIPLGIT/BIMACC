 ...
 <div class="row">
          <div class="col-md-4"> 
            <div class="form-group">
             ...
             <input type="text" id="svesselname"  value="{{ $details->vesselname }}" class="form-control{{ $errors->has('vesselname') ? ' is-invalid' : '' }}" name="vesselname" >
        ...
        <div class="col-md-4"> 
          <div class="form-group">
            <input type="text" id="scargonature" value="{{ $details->cargoname }}" class="form-control{{ $errors->has('cargonature') ? ' is-invalid' : '' }}" name="cargoname" >
        ...
        <div class="col-md-4"> 
         <div class="form-group">
           <input type="text"  id="squantity" value="{{ $details->quantity }}" class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" name="quantity" >
    ...
    <div class="row">
      <div class="col-md-6">  
        <div class="form-group">
         <input type="text" id="sinjurydetails" value="{{ $details->lossdetails }}" class="form-control{{ $errors->has('injurydetails') ? ' is-invalid' : '' }}" name="lossdetails">
...
<div class="row">
 <div class="col-md-4"> 
      <div class="form-group">
       <input type="text" onkeypress="return isNumberKey(event)"  id="sclaimamount" value="{{ number_format((float)$details->claimamount, 2, '.', '') }}" class="form-control{{ $errors->has('claimamount') ? ' is-invalid' : '' }}" name="claimamount" >
  ...
  <div class="col-md-4"> 
  <div class="form-group">
    <input type="text" onkeypress="return isNumberKey(event)"  id="sclaim_interest" value="{{ $details->claim_interest }}" class="form-control{{ $errors->has('claim_interest') ? ' is-invalid' : '' }}" name="claim_interest" >
...
<div class="col-md-4"> 
  <div class="form-group">
    ...
    <input type="checkbox" class="form-control check-size" id="sclaimamountwithinterest"  name="claimamountwithinterest" style="width:7%" value="yes"  {{ $details->claimamountwithinterest == 'yes' ? 'checked' : ''}}>
  </div>
</div>
</div>
...
<div class="row">
  <div class="col-md-4"> 
    <div class="form-group">
     <input type="date"  id="scontractdate" value="{{ $details->contractdate }}" class="datechk form-control{{ $errors->has('contractdate') ? ' is-invalid' : '' }}" name="contractdate" >
...
<div class="col-md-4"> 
  <div class="form-group">
    <input type="text" id="sBill_of_Lading_details_Date_No" value="{{ $details->bill_of_lading_details_date_no }}" class="form-control{{ $errors->has('Bill_of_Lading_details_Date_No') ? ' is-invalid' : '' }}" name="bill_of_lading_details_date_no" >
...
<div class="col-md-4"> 
 <div class="form-group">
   <input type="date"  id="spassenger_ticket_booking_date" value="{{ $details->passenger_ticket_booking_date }}" class="datechk form-control{{ $errors->has('passenger_ticket_booking_date') ? ' is-invalid' : '' }}" name="passenger_ticket_booking_date" >
...
<div class="row">
  <div class="col-md-6"> 
    <div class="form-group">
     <input type="date"  id="sdue_date" value="{{ $details->due_date }}" class="datechk form-control{{ $errors->has('due_date') ? ' is-invalid' : '' }}" name="due_date" >
...
<div class="col-md-6"> 
  <div class="form-group">
    <input type="date"  id="snoticedate" value="{{ $details->noticedate }}" class="datechk form-control{{ $errors->has('noticedate') ? ' is-invalid' : '' }}" name="noticedate" >
